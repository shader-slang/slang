...
| `slang-unit-test-tool/nvvmSlangUnsupportedIRStopsBeforeEmission` | Multiplication and void helper calls remain deterministic E52017 boundaries before builder discovery or libNVVM program creation | Pass |
