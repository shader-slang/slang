...
| `slang-unit-test-tool/nvvmSlangUnsupportedIRStopsBeforeEmission` | Signed-i32 shifts, division, and remainder remain opcode boundaries; logical NOT and unsigned or i64 bitwise AND/OR/XOR/NOT remain raw entry-parameter boundaries; unsigned/wide/floating multiplication, void helper calls, and unsigned pointer offsets also remain deterministic E52017 boundaries before builder discovery or libNVVM program creation | Pass |
