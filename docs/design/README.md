...
The [Shader Coverage](shader-coverage.md) document describes the current architecture for shader coverage instrumentation, including the interaction between AST-time synthesis and post-emit metadata.
