...
| `SLANG_ENABLE_VALIDATION_FULL_IR`     | `FALSE`                       | Enable full IR validation (SLOW!)                                                                                                                                                                                                  |
| `SLANG_ENABLE_VALIDATION_FOSSIL`      | `FALSE`                       | Validate serialized fossil data (such as `.slang-module` files) when it is loaded (SLOW!). Enable this when loading untrusted modules.                                                                                             |
