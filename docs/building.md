...
| `SLANG_ENABLE_SPIRV_OPT_MERGE_RETURN` | `TRUE`                             | **Will be removed.** Enable SPIRV-Tools `MergeReturnPass` + `InlineExhaustivePass` for debug-info SPIR-V; set to `FALSE` to work around [SPIRV-Tools#6711](https://github.com/KhronosGroup/SPIRV-Tools/issues/6711) |
