...
| `SLANG_ENABLE_SPIRV_OPT_PRIVATE_TO_LOCAL` | `FALSE`                              | Register the SPIRV-Tools `PrivateToLocalPass`; the `FALSE` default fixes [shader-slang/slang#11651](https://github.com/shader-slang/slang/issues/11651), `TRUE` keeps the previous SPIR-V output                                                                                                                                             |
