...
| `SLANG_ENABLE_SPIRV_OPT_MERGE_RETURN` | `TRUE`                             | Enable SPIRV-Tools `MergeReturnPass` + `InlineExhaustivePass` in SPIR-V optimization. Set to `FALSE` for the upstream UAF workaround — see [SPIRV-Tools#6711](https://github.com/KhronosGroup/SPIRV-Tools/issues/6711) |
