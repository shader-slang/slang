...
cmake.exe . -B build-generated
cmake.exe --build build-generated --config Release

# Go back to repository root
cd ../..
```

Do not name the CMake build directory `build`. SPIRV-Tools' `DEPS` file has a `build` entry
that checks out Chromium's `//build` tree into `external/spirv-tools/build/`, so the
`git-sync-deps` step above fills that directory with unrelated Chromium headers
(`build_config.h`, `buildflag.h`, `precompile.h`). Configuring CMake into the same directory
would mix those headers in with the generated ones, and the copy step below would pick them
up — which the `Verify SPIRV Generated Files` CI job then reports as orphaned files.
...
## Copy the generated files from `spirv-tools/build-generated/` to `spirv-tools-generated/`

Copy the generated header files from `external/spirv-tools/build-generated/` to `external/spirv-tools-generated/`.

```
rm external/spirv-tools-generated/*.h
rm external/spirv-tools-generated/*.inc
cp external/spirv-tools/build-generated/*.h external/spirv-tools-generated/
cp external/spirv-tools/build-generated/*.inc external/spirv-tools-generated/
```
...
To fix the issue, follow the instructions in the CI output, or re-run the steps in the [Copy the generated files](#copy-the-generated-files-from-spirv-toolsbuild-generated-to-spirv-tools-generated) section above.
