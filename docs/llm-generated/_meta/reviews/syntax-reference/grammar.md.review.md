...
| --- | --- | --- | --- | --- | --- |
| F-001 | major | required sections | Required top-level sections `## Attributes and decorations` and `## Generics and where-clauses` are missing; content is folded into other sections. | `docs/llm-generated/_meta/prompts/syntax-grammar.md` requires those headings. | Add the required headings or split existing content under those headings. |
