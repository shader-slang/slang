...
| F-003 | minor | `## Expression keywords` | `new` is omitted even though the prompt calls it out and the parser handles it specially. | `source/slang/slang-parser.cpp:9206-9209` handles `new`; `docs/llm-generated/_meta/prompts/syntax-keywords-and-builtins.md` calls it out. | Add `new` to expression or special expression keywords. |
