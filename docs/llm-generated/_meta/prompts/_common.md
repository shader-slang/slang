...
The pages under `docs/llm-generated/ast-reference/` share a common shape.
...
6. `## See also` — bullet list linking peer reference pages
   ...
   `docs/llm-generated/pipeline/` doc. Always include the parsing
...
The pages under `docs/llm-generated/name-resolution/` document the
...
The pages under `docs/llm-generated/ir-reference/` are an exhaustive
...
The pages under `docs/llm-generated/target-pipelines/` document, for
...
The page `docs/llm-generated/target-pipelines/index.md` is a
...
The page `docs/llm-generated/pipeline/04b-pre-link-passes.md`
