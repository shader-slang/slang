...
Produce `docs/llm-generated/ast-reference/index.md` — a short
...
`docs/llm-generated/ast-reference/` and needs to pick the right page.
...
5. `## Cross-cutting topics` — bullets pointing at the
   ...
   `docs/llm-generated/cross-cutting/` documents that touch the AST:
