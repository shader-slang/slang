...
`docs/llm-generated/` workflow. The review must be performed by a model
...
Review one generated document under `docs/llm-generated/` against the
...
1. The **target document** — its workspace-relative path under
   `docs/llm-generated/` (the manifest key, e.g.
...
2. The **generation prompt** the document was produced from — i.e.
   the contents of `docs/llm-generated/_meta/prompts/_common.md`
...
```
docs/llm-generated/_meta/reviews/<target_doc>.review.md
```
