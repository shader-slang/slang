...
target_doc_watched_paths_digest: b73ab2763cf90e18015e6beb407b431f76d9344148801d3a27089be1611f45e2
...
## Items checked
- Checked `UnscopedEnumAttribute` and `EnumClassModifier` coverage against parser and modifier-checking source.
...
## No-issues notes
- The enum modifier/attribute descriptions match parser and checker handling.
