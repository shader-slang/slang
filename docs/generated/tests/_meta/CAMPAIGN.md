...
| `docs/language-reference/attributes.md`                                                                | Stale (2026-02-04). Despite being the "Attributes" chapter, documents a single attribute (`[[vk::spirv_instruction]]`); SPIRV-emit-only, below the ~3-claim bundle threshold. Revisit if the chapter is expanded to cover attributes generally.  | 2026-06-02 |
| `docs/language-reference/shaders-and-kernels.md`                                                       | 26 lines, no headings; fewer than 3 testable normative claims. Execution-model surface is covered by `basics-program-execution`.                                                                                                                 | 2026-06-02 |
| `docs/language-reference/basics-behavior.md`                                                           | 33 lines; non-normative behavior-class taxonomy prose; no observable compiler surface.                                                                                                                                                           | 2026-06-02 |
| `docs/language-reference/preprocessor.md`                                                              | 19 lines; too thin / placeholder. Revisit if expanded (preprocessor behavior is otherwise covered by the `design/pipeline/01-lex-preprocess` regression bundle).                                                                                 | 2026-06-02 |
| `docs/language-reference/types-class.md`, `types-special.md`, `types-traits.md`, `types-attributes.md` | Stubs (3–22 lines), TODO/placeholder; below the ~3-claim threshold. Revisit when fleshed out.                                                                                                                                                    | 2026-06-02 |
| `docs/language-reference/basics-name-lookup.md`, `expressions-value-categories.md`                     | Stubs (4–7 lines); no testable claims yet.                                                                                                                                                                                                       | 2026-06-02 |
| `docs/language-reference/types.md`, `expressions.md`, `basics.md`, `basics-translation-overview.md`    | Umbrella / overview chapters — descriptive-doc exemption; their claims are exercised by the per-topic sub-bundles.                                                                                                                               | 2026-06-02 |
