# Prompt: docs/generated/tests/cross-cutting/serialization/
...
```
//TEST:COMPILE: docs/generated/tests/cross-cutting/serialization/<src>.slang -o docs/generated/tests/cross-cutting/serialization/<out>.slang-module
//TEST:SIMPLE(filecheck=CHECK): -dump-module docs/generated/tests/cross-cutting/serialization/<out>.slang-module
```
...
- **`//TEST:COMPILE:` writes its output file relative to the
  ...
  the path as `docs/generated/tests/cross-cutting/serialization/foo.slang-module`,
