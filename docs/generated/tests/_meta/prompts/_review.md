# Review Prompt — docs/generated/tests bundles
...
`docs/generated/tests/<bundle-key>/`. The bundle was produced by an agent
from another model family using the prompt at
`docs/generated/tests/_meta/prompts/<per-section>.md` and
`docs/generated/tests/_meta/prompts/_common.md`, against the source documentation
at the bundle's `source_doc`.

You produce a single **review report** at
`docs/generated/tests/_meta/reviews/<bundle-key>.review.md`.
...
- the bundle's `source_doc` (the docs/generated/design/ file the tests are
  anchored to);
...
Save your output to
`docs/generated/tests/_meta/reviews/<bundle-key>.review.md`. Use exactly this
shape:
