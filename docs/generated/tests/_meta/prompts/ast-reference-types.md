# Prompt: docs/generated/tests/ast-reference/types/
...
- `docs/generated/tests/ast-reference/expressions/` — covers the
  **type-expression family** (`PointerTypeExpr`, `FuncTypeExpr`,
  ...
  refuses assignment).
- `docs/generated/tests/ir-reference/types/` — covers the **IR** type
...
- `docs/generated/tests/pipeline/03-semantic-check/` — covers the
