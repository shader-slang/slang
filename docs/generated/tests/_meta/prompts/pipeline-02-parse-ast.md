# Prompt: docs/generated/tests/pipeline/02-parse-ast/
...
`docs/generated/tests/pipeline/01-lex-preprocess/` and must not be
...
2. One test file per **verifiable claim** in
   ...
   - **type-shape claims** — that array, pointer, optional (`?`),
     ...
     `docs/generated/tests/syntax-reference/grammar.md` is the authoritative
