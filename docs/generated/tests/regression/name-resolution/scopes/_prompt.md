# Prompt: docs/generated/tests/regression/name-resolution/scopes/
...
Produce the test bundle at `docs/generated/tests/regression/name-resolution/scopes/`,
anchored to
...
2. A test file per **verifiable scoping claim** in
   ...
   - **a name resolves where the doc says it does** —
     ...
     value;
   - **a name is _not_ in scope at a particular point** —
...
3. Coverage per claim:
   ...
   - At least one negative test that proves the _boundary_ of each
...
- `docs/generated/design/ast-reference/statements.md`
...
- "Same input is rejected at point P even though _other_ candidates
