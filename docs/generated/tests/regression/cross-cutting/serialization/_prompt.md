# Prompt: docs/generated/tests/regression/cross-cutting/serialization/
...
Produce the test bundle at `docs/generated/tests/regression/cross-cutting/serialization/`,
anchored to
...
- `docs/generated/design/cross-cutting/serialization.md`
...
```
//TEST:COMPILE: docs/generated/tests/regression/cross-cutting/serialization/<src>.slang -o docs/generated/tests/regression/cross-cutting/serialization/<out>.slang-module
//TEST:SIMPLE(filecheck=CHECK): -dump-module docs/generated/tests/regression/cross-cutting/serialization/<out>.slang-module
```
...
- **`//TEST:COMPILE:` writes its output file relative to the
  ...
  the path as `docs/generated/tests/regression/cross-cutting/serialization/foo.slang-module`,
