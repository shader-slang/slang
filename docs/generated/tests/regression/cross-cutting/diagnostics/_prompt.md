# Prompt: docs/generated/tests/regression/cross-cutting/diagnostics/
...
Produce the test bundle at `docs/generated/tests/regression/cross-cutting/diagnostics/`,
anchored to
...
- [ ] At least one test exercises a multi-span diagnostic (primary + note), since the doc explicitly describes notes.
