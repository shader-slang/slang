# Prompt: docs/generated/tests/regression/ast-reference/types/
...
Produce the test bundle at `docs/generated/tests/regression/ast-reference/types/`,
anchored to
...
- `docs/generated/tests/regression/ast-reference/expressions/` — covers the
  **type-expression family** (`PointerTypeExpr`, `FuncTypeExpr`,
  ...
  refuses assignment).
- `docs/generated/tests/regression/ir-reference/types/` — covers the **IR** type
...
- `docs/generated/tests/regression/pipeline/03-semantic-check/` — covers the
