# Prompt: docs/generated/tests/regression/ast-reference/modifiers/
...
Produce the test bundle at `docs/generated/tests/regression/ast-reference/modifiers/`,
anchored to
...
- `ast-reference/declarations/` — covers declarations that
  _carry_ modifiers (e.g. `VarDecl` with `const`); the
