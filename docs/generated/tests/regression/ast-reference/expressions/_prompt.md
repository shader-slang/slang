# Prompt: docs/generated/tests/regression/ast-reference/expressions/
...
Produce the test bundle at `docs/generated/tests/regression/ast-reference/expressions/`,
anchored to
...
- `docs/generated/tests/regression/pipeline/02-parse-ast/` covers **parse-stage**
...
- `docs/generated/tests/regression/pipeline/03-semantic-check/` covers **checker-stage**
...
- `docs/generated/tests/regression/ast-reference/base/` covers the abstract-base-class
