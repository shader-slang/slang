# Prompt: docs/generated/tests/regression/pipeline/02-parse-ast/
...
Produce the test bundle at `docs/generated/tests/regression/pipeline/02-parse-ast/`,
anchored to
...
`docs/generated/tests/regression/pipeline/01-lex-preprocess/` and must not be
...
2. One test file per **verifiable claim** in
   ...
   - **type-shape claims** — that array, pointer, optional (`?`),
     ...
     `docs/generated/tests/regression/syntax-reference/grammar.md` is the authoritative
