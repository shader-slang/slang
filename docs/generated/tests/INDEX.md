...
| --- | ---: | --- |
| [`conformance/basics-execution-divergence-reconvergence`](conformance/basics-execution-divergence-reconvergence/README.md) | 16 | [`docs/language-reference/basics-execution-divergence-reconvergence.md`](../../language-reference/basics-execution-divergence-reconvergence.md) |
| [`conformance/basics-memory-model-address-spaces`](conformance/basics-memory-model-address-spaces/README.md) | 40 | [`docs/language-reference/basics-memory-model-address-spaces.md`](../../language-reference/basics-memory-model-address-spaces.md) |
| [`conformance/basics-memory-model-consistency`](conformance/basics-memory-model-consistency/README.md) | 23 | [`docs/language-reference/basics-memory-model-consistency.md`](../../language-reference/basics-memory-model-consistency.md) |
| [`conformance/basics-memory-model-special-topics`](conformance/basics-memory-model-special-topics/README.md) | 32 | [`docs/language-reference/basics-memory-model-special-topics.md`](../../language-reference/basics-memory-model-special-topics.md) |
...
| [`conformance/expressions-identifier`](conformance/expressions-identifier/README.md) | 13 | [`docs/language-reference/expressions-identifier.md`](../../language-reference/expressions-identifier.md) |
| [`conformance/expressions-initializer`](conformance/expressions-initializer/README.md) | 13 | [`docs/language-reference/expressions-initializer.md`](../../language-reference/expressions-initializer.md) |
...
| [`conformance/expressions-operator-precedence`](conformance/expressions-operator-precedence/README.md) | 29 | [`docs/language-reference/expressions-operator-precedence.md`](../../language-reference/expressions-operator-precedence.md) |
...
| [`conformance/generics`](conformance/generics/README.md) | 39 | [`docs/language-reference/generics.md`](../../language-reference/generics.md) |
...
| [`conformance/statements`](conformance/statements/README.md) | 47 | [`docs/language-reference/statements.md`](../../language-reference/statements.md) |
...
| [`conformance/types-interface`](conformance/types-interface/README.md) | 42 | [`docs/language-reference/types-interface.md`](../../language-reference/types-interface.md) |
...
| [`conformance/types-struct`](conformance/types-struct/README.md) | 37 | [`docs/language-reference/types-struct.md`](../../language-reference/types-struct.md) |
...
| [`design/pipeline/03-semantic-check`](design/pipeline/03-semantic-check/README.md) | 79 | [`docs/generated/design/pipeline/03-semantic-check.md`](../design/pipeline/03-semantic-check.md) |
...
| [`design/pipeline/06-emit`](design/pipeline/06-emit/README.md) | 49 | [`docs/generated/design/pipeline/06-emit.md`](../design/pipeline/06-emit.md) |
...
| [`design/syntax-reference/keywords-and-builtins`](design/syntax-reference/keywords-and-builtins/README.md) | 62 | [`docs/generated/design/syntax-reference/keywords-and-builtins.md`](../design/syntax-reference/keywords-and-builtins.md) |
...
| [`design/cross-cutting/ir-instructions`](design/cross-cutting/ir-instructions/README.md) | 32 | [`docs/generated/design/cross-cutting/ir-instructions.md`](../design/cross-cutting/ir-instructions.md) |
| [`design/cross-cutting/serialization`](design/cross-cutting/serialization/README.md) | 11 | [`docs/generated/design/cross-cutting/serialization.md`](../design/cross-cutting/serialization.md) |
| [`design/cross-cutting/targets`](design/cross-cutting/targets/README.md) | 37 | [`docs/generated/design/cross-cutting/targets.md`](../design/cross-cutting/targets.md) |
...
| [`design/ast-reference/expressions`](design/ast-reference/expressions/README.md) | 104 | [`docs/generated/design/ast-reference/expressions.md`](../design/ast-reference/expressions.md) |
| [`design/ast-reference/modifiers`](design/ast-reference/modifiers/README.md) | 69 | [`docs/generated/design/ast-reference/modifiers.md`](../design/ast-reference/modifiers.md) |
...
| [`design/ast-reference/values`](design/ast-reference/values/README.md) | 13 | [`docs/generated/design/ast-reference/values.md`](../design/ast-reference/values.md) |
...
| [`design/ir-reference/types`](design/ir-reference/types/README.md) | 144 | [`docs/generated/design/ir-reference/types.md`](../design/ir-reference/types.md) |
| [`design/ir-reference/values`](design/ir-reference/values/README.md) | 137 | [`docs/generated/design/ir-reference/values.md`](../design/ir-reference/values.md) |

### Target pipelines

| Bundle | Tests | Source doc |
| --- | ---: | --- |
| [`design/target-pipelines/cuda`](design/target-pipelines/cuda/README.md) | 71 | [`docs/generated/design/target-pipelines/cuda.md`](../design/target-pipelines/cuda.md) |
| [`design/target-pipelines/hlsl`](design/target-pipelines/hlsl/README.md) | 154 | [`docs/generated/design/target-pipelines/hlsl.md`](../design/target-pipelines/hlsl.md) |
| [`design/target-pipelines/metal`](design/target-pipelines/metal/README.md) | 81 | [`docs/generated/design/target-pipelines/metal.md`](../design/target-pipelines/metal.md) |
| [`design/target-pipelines/spirv`](design/target-pipelines/spirv/README.md) | 147 | [`docs/generated/design/target-pipelines/spirv.md`](../design/target-pipelines/spirv.md) |
| [`design/target-pipelines/wgsl`](design/target-pipelines/wgsl/README.md) | 80 | [`docs/generated/design/target-pipelines/wgsl.md`](../design/target-pipelines/wgsl.md) |
