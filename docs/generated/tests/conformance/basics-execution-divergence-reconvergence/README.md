...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| C4: `if`/`else` divergence — SPIRV `OpSelectionMerge`+`OpBranchConditional`; HLSL/GLSL/Metal/WGSL/CUDA/C++ preserve the if/else arms.                                                                                                                                                                                           | functional | [#divergence](../../../../language-reference/basics-execution-divergence-reconvergence.md#divergence) | [`if-divergence-reconvergence-emission.slang`](if-divergence-reconvergence-emission.slang)           |
