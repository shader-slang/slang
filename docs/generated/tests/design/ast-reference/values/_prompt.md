# Prompt: docs/generated/tests/design/ast-reference/values/
...
Produce the test bundle at `docs/generated/tests/design/ast-reference/values/`,
anchored to
...
- `docs/generated/tests/design/ast-reference/types/` — covers the **`Type`**
  side. `Type` _is_ a `Val`, but its concrete subclasses are
  exercised there. Do not retest type-class observations here.
- `docs/generated/tests/design/ast-reference/declarations/` — covers the **`Decl`**
  side that `DeclRefBase` references. Do not retest decl mechanics
  here.
- `docs/generated/tests/design/ast-reference/expressions/` — covers expressions
...
- `docs/generated/tests/design/ast-reference/modifiers.md` — covers AST modifiers.
  ...
  duplicate.
- `docs/generated/tests/design/ir-reference/types/` — covers the IR-level
  observations. Do not re-test IR spellings here; this bundle
  stays at the AST / type-checker surface (interpreter values and
  diagnostics).
- `docs/generated/tests/design/pipeline/03-semantic-check/` — covers
