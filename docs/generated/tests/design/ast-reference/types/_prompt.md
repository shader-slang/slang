# Prompt: docs/generated/tests/design/ast-reference/types/
...
Produce the test bundle at `docs/generated/tests/design/ast-reference/types/`,
anchored to
...
- `docs/generated/tests/design/ast-reference/expressions/` — covers the
  **type-expression family** (`PointerTypeExpr`, `FuncTypeExpr`,
  ...
  refuses assignment).
- `docs/generated/tests/design/ir-reference/types/` — covers the **IR** type
...
- `docs/generated/tests/design/pipeline/03-semantic-check/` — covers the
...
- `docs/generated/design/ir-reference/types.md` (cross-link only, not a
  test anchor)
