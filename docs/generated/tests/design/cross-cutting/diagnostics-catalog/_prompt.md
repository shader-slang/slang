# Prompt: docs/generated/tests/design/cross-cutting/diagnostics-catalog/
...
`docs/generated/tests/design/cross-cutting/diagnostics-catalog/`.
...
section in `docs/generated/design/cross-cutting/diagnostics.md` —
though the narrative doc is also referenced for general framing.

## Inputs available to you

- **`docs/generated/tests/_meta/diagnostics-catalog/catalog.txt`** — full
  catalog snapshot (695 codes) with severity / name / source /
  message columns. Authoritative.
- **`docs/generated/tests/_meta/diagnostics-catalog/uncovered-bucket-<N>.txt`**
  ...
  codes outside yours.
- The narrative doc:
  `docs/generated/design/cross-cutting/diagnostics.md` — for framing
