...
14. `[__ref]` is the third modifier a `FunctionDeclBase` consults when updating `thisParameterMode`.
...
| `[__ref]` is the third modifier a function declaration consults when updating the this-parameter mode; the bare `[ref]` spelling is an unknown attribute and leaves `this` immutable. | negative | [#unqualified-lookup](../../../../design/name-resolution/lookup.md#unqualified-lookup) | [`ref-attribute-spelling-makes-this-mutable.slang`](ref-attribute-spelling-makes-this-mutable.slang) |
