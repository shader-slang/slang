...
watched_paths_digest: 6c82a300975905673577576ebaca8a292bb446b25fdb648371801e34e2ba45a5
source_doc: docs/generated/design/pipeline/overview.md
source_doc_digest: ccae4a0249559c5338a677481fb182f985e80da86b0cbd05f166d925ebb771c3
...
| Determinism of the compiler (compile twice → identical text). The doc does not currently make a determinism claim, so no test can anchor to it; noting it here so a future doc revision that adds the claim picks up a test.                              | needs-cli-test | [#end-to-end-flow](../../../design/pipeline/overview.md#end-to-end-flow) | No `slang-test` directive diffs two independent compiles of the same source; a wrapper script invoking `slangc` twice and diffing the outputs would verify it, once the doc states the claim. |
