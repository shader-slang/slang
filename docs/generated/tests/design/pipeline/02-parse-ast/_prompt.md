# Prompt: docs/generated/tests/design/pipeline/02-parse-ast/
...
Produce the test bundle at `docs/generated/tests/design/pipeline/02-parse-ast/`,
anchored to
...
`docs/generated/tests/design/pipeline/01-lex-preprocess/` and must not be
...
2. One test file per **verifiable claim** in
   ...
   - **type-shape claims** — that array, pointer, optional (`?`),
     ...
     `docs/generated/tests/design/syntax-reference/grammar.md` is the authoritative
...
- `docs/generated/design/ast-reference/statements.md` — for the
