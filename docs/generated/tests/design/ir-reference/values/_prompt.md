# Prompt: docs/generated/tests/design/ir-reference/values/
...
Produce the test bundle at `docs/generated/tests/design/ir-reference/values/`,
anchored to
...
- **`makeTuple`** — `makeTuple(a, b)` surface lowers to
  ...
  (`t._0`) lowers to `swizzle(%t, 0 : Int)`, _not_ the
