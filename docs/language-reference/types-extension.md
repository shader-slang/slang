...
> which member takes effect; the compiler now emits a diagnostic flagging this conflict, without
> determining which declaration is used. ([Issue #9660](https://github.com/shader-slang/slang/issues/9660))
