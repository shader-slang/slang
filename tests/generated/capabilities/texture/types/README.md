...
This verifies that the `[require(...)]`, `__requireCapability()`, and `static_assert()` statements gating
feature enablement are present and match with the documentation. See, e.g., texture type vs minimum backend
version table in Slang Standard Library Reference / _Texture [1].
