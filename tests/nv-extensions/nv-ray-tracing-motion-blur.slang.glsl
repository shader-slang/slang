...
void TraceMotionRay_0(accelerationStructureEXT AccelerationStructure_0, uint RayFlags_0, uint InstanceInclusionMask_0, uint RayContributionToHitGroupIndex_0, uint MultiplierForGeometryContributionToHitGroupIndex_0, uint MissShaderIndex_0, RayDesc_0 Ray_0, float CurrentTime_0, inout ShadowRay_0 Payload_0)
{
    p_1 = Payload_0;
    int _S2 = (1);
    traceRayMotionNV(AccelerationStructure_0, RayFlags_0, InstanceInclusionMask_0, RayContributionToHitGroupIndex_0, MultiplierForGeometryContributionToHitGroupIndex_0, MissShaderIndex_0, Ray_0.Origin_0, Ray_0.TMin_0, Ray_0.Direction_0, Ray_0.TMax_0, CurrentTime_0, _S2);
    Payload_0 = p_1;
    return;
}
...
void TraceRay_0(accelerationStructureEXT AccelerationStructure_1, uint RayFlags_1, uint InstanceInclusionMask_1, uint RayContributionToHitGroupIndex_1, uint MultiplierForGeometryContributionToHitGroupIndex_1, uint MissShaderIndex_1, RayDesc_0 Ray_1, inout ReflectionRay_0 Payload_1)
{
    p_0 = Payload_1;
    int _S3 = (0);
    traceRayEXT(AccelerationStructure_1, RayFlags_1, InstanceInclusionMask_1, RayContributionToHitGroupIndex_1, MultiplierForGeometryContributionToHitGroupIndex_1, MissShaderIndex_1, Ray_1.Origin_0, Ray_1.TMin_0, Ray_1.Direction_0, Ray_1.TMax_0, _S3);
    Payload_1 = p_0;
    return;
}
...
void main()
{
    ...
    ivec2 launchID_0 = ivec2(_S4.xy);
    uvec3 _S5 = ((gl_LaunchSizeEXT));
    ivec2 launchSize_0 = ivec2(_S5.xy);

    float _S6 = (float(launchID_0.x) + 0.5) / float(launchSize_0.x);
    float _S7 = (float(launchID_0.y) + 0.5) / float(launchSize_0.y);
    vec2 inUV_0 = vec2(_S6, _S7);
    vec4 _S8 = (texture(sampler2D(samplerPosition_0,sampler_0), (inUV_0)));
    vec3 P_0 = _S8.xyz;
    vec4 _S9 = (texture(sampler2D(samplerNormal_0,sampler_0), (inUV_0)));
    vec3 N_0 = _S9.xyz * 2.0 - 1.0;
    ...
    float _S10 = 1.0 / (lightDist_0 * lightDist_0);
    RayDesc_0 ray_0;
    ray_0.Origin_0 = P_0;
