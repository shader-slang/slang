...
# PointerAddress (float* via device_address) works on both Vulkan and CUDA.
# DescriptorHandle only works on Vulkan (SLANG_E_NOT_IMPLEMENTED on CUDA).
POINTER_DEVICE_TYPES: list[spy.DeviceType] = [spy.DeviceType.cuda]
