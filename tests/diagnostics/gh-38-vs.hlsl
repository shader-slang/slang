//DIAGNOSTIC_TEST:SIMPLE(diag=CHECK,non-exhaustive): -profile sm_5_0 -entry main1 -stage vertex tests/diagnostics/gh-38-fs.hlsl -entry main -stage fragment -no-codegen
