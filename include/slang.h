...
#define SLANG_UUID_ISlangSharedLibraryLoader ISlangSharedLibraryLoader::getTypeGuid()
    ...
    without a path) */
    typedef void (*FileSystemContentsCallBack)(
...
struct UserAttribute
{
    ...
    {
        return (uint32_t
        )spReflectionUserAttribute_GetArgumentCount((SlangReflectionUserAttribute*)this);
    }
    TypeReflection* getArgumentType(uint32_t index)
    {
        return (TypeReflection*)
            spReflectionUserAttribute_GetArgumentType((SlangReflectionUserAttribute*)this, index);
    }
...
struct TypeReflection
{
    ...
    UserAttribute* findUserAttributeByName(char const* name)
    {
        return (UserAttribute*)
            spReflectionType_FindUserAttributeByName((SlangReflectionType*)this, name);
    }
...
struct TypeLayoutReflection
{
    ...
    VariableLayoutReflection* getFieldByIndex(unsigned int index)
    {
        return (VariableLayoutReflection*)
            spReflectionTypeLayout_GetFieldByIndex((SlangReflectionTypeLayout*)this, index);
    }
    ...
    ParameterCategory getParameterCategory()
    {
        ...
        )spReflectionTypeLayout_GetParameterCategory((SlangReflectionTypeLayout*)this);
    }
    ...
    {
        return (ParameterCategory
        )spReflectionTypeLayout_GetCategoryByIndex((SlangReflectionTypeLayout*)this, index);
    }
    ...
    {
        return (BindingType
        )spReflectionTypeLayout_getBindingRangeType((SlangReflectionTypeLayout*)this, index);
    }
    ...
    */
    ...
    ParameterCategory
    getDescriptorSetDescriptorRangeCategory(SlangInt setIndex, SlangInt rangeIndex)
    {
...
struct VariableReflection
{
    ...
    {
        return (Modifier*)
            spReflectionVariable_FindModifier((SlangReflectionVariable*)this, (SlangModifierID)id);
    }
    ...
    {
        return (UserAttribute*)
            spReflectionVariable_GetUserAttribute((SlangReflectionVariable*)this, index);
    }
...
struct FunctionReflection
{
    ...
    {
        return (VariableReflection*)
            spReflectionFunction_GetParameter((SlangReflectionFunction*)this, index);
    }
    ...
    {
        return (UserAttribute*)
            spReflectionFunction_GetUserAttribute((SlangReflectionFunction*)this, index);
    }
    UserAttribute* findUserAttributeByName(SlangSession* globalSession, char const* name)
    {
    ...
    {
        return (Modifier*)
            spReflectionFunction_FindModifier((SlangReflectionFunction*)this, (SlangModifierID)id);
    }
    ...
    FunctionReflection* getOverload(unsigned int index)
    {
        return (FunctionReflection*)
            spReflectionFunction_getOverload((SlangReflectionFunction*)this, index);
    }
};
...
struct GenericReflection
{
    ...
    {
        return (VariableReflection*)
            spReflectionGeneric_GetValueParameter((SlangReflectionGeneric*)this, index);
    }
...
struct EntryPointReflection
{
    ...
    {
        return (VariableLayoutReflection*)
            spReflectionEntryPoint_getParameterByIndex((SlangReflectionEntryPoint*)this, index);
    }
...
struct ShaderReflection
{
    ...
    TypeParameterReflection* getTypeParameterByIndex(unsigned index)
    {
        return (TypeParameterReflection*)
            spReflection_GetTypeParameterByIndex((SlangReflection*)this, index);
    }

    TypeParameterReflection* findTypeParameter(char const* name)
    {
        return (TypeParameterReflection*)
            spReflection_FindTypeParameter((SlangReflection*)this, name);
    }

    VariableLayoutReflection* getParameterByIndex(unsigned index)
    {
        return (VariableLayoutReflection*)
            spReflection_GetParameterByIndex((SlangReflection*)this, index);
    }
    ...
    getTypeLayout(TypeReflection* type, LayoutRules rules = LayoutRules::Default)
    {
    ...
    {
        return (EntryPointReflection*)
            spReflection_findEntryPointByName((SlangReflection*)this, name);
    }
...
struct IGlobalSession : public ISlangUnknown
{
    ...
    */
    virtual SLANG_NO_THROW void SLANG_MCALL setSharedLibraryLoader(ISlangSharedLibraryLoader* loader
    ) = 0;
    ...
    */
    virtual SLANG_NO_THROW SlangResult SLANG_MCALL
    loadStdLib(const void* stdLib, size_t stdLibSizeInBytes) = 0;
    ...
    NOTE! API is experimental and not ready for production code  */
    virtual SLANG_NO_THROW SlangResult SLANG_MCALL
    saveStdLib(SlangArchiveType archiveType, ISlangBlob** outBlob) = 0;
