...
typedef uint32_t SlangSizeT;
    ...
    */
    ...
    enum class CompilerOptionName
    {
        ...
        // Appended after the option slots master claimed first (156/157, then 158); these
        // keep the append-only enum contract for the public header.
        SaveAutodiffModule = 159,
        SaveAutodiffModuleBinSource = 160,
