...
static SlangResult
_findDownstreamCompiler(const UnownedStringSlice& slice, SlangPassThrough& outDownstreamCompiler)
{
...
/* static */ ParseDiagnosticUtil::LineParser
ParseDiagnosticUtil::getLineParser(const CompilerIdentity& compilerIdentity)
{
...
/* static */ SlangResult
ParseDiagnosticUtil::parseOutputInfo(const UnownedStringSlice& inText, OutputInfo& out)
{
    enum State
    {
        Normal,
