...
public:
    ...
    ///
    /// TODO(JS): We could split the stdlib compilation from other actions, and have timeout
    /// specific for that. To do this we could have a 'compileStdLib' RPC method.
    ///
