...
/* static */ void Options::showHelp(WriterHelper stdOut)
{
    stdOut.print(
        ...
        "                                 Also matches the expanded subtest name\n"
        "                                 exactly (e.g.\n"
        "                                 \"tests/foo.slang.6 syn (llvm)\") so a\n"
        "                                 single crashing subtest can be skipped.\n"
        ...
        "  -skip-list <file>              Specify file containing tests to skip\n"
        "                                 (path prefixes, or exact-match expanded\n"
        "                                 subtest names like\n"
        "                                 \"tests/foo.slang.6 syn (llvm)\")\n"
