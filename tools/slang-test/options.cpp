...
/* static */ void Options::showHelp(WriterHelper stdOut)
{
    stdOut.print(
        ...
        "  -exclude-prefix <prefix>       Exclude tests by path prefix, by subtest stem\n"
        "                                 ('<path>.<idx>'), or by full expanded subtest\n"
        "                                 name ('<path>.<idx> syn (<api>)')\n"
        ...
        "  -skip-list <file>              Specify file of tests to skip (path prefix, subtest\n"
        "                                 stem, or full expanded subtest name; one per line)\n"
