...
//         void createCompositeTransformer(IShaderObject** transformer)
//         {
//             slang::TypeReflection* compTransformerType =
//                 slangReflection->findTypeByName("CompositeTransformer");
//             GFX_CHECK_CALL_ABORT(device->createShaderObject(
//                 compTransformerType, ShaderObjectContainerType::None, transformer));
// 
//             ComPtr<IShaderObject> func0;
//             ComPtr<IShaderObject> func1;
//             createAddTransformer(func0.writeRef());
//             createMulTransformer(func1.writeRef());
//             ShaderCursor(*transformer).getPath("func0").setObject(func0);
//             ShaderCursor(*transformer).getPath("func1").setObject(func1);
//         }
        ...
        void submitGPUWork(GfxIndex transformerType)
        {
            ...
            case 1:
                ...
                break;
//             case 2:
//                 createCompositeTransformer(transformer.writeRef());
//                 break;
            default:
                /* Should not get here */
                SLANG_IGNORE_TEST;
