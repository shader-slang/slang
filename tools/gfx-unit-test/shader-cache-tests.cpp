...
struct ShaderCacheTest
{
    ...
    void createComputeResources()
    {
        ...
        GFX_CHECK_CALL_ABORT(
            device->createBufferResource(bufferDesc, (void*)initialData, bufferResource.writeRef())
        );
...
struct ShaderCacheTestGraphicsSplit : ShaderCacheTestGraphics
{
    void createGraphicsPipeline()
    {
        ...
        GFX_CHECK_CALL_ABORT(vertexModule->findEntryPointByName("main", vertexEntryPoint.writeRef())
        );
