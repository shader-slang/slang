...
ComPtr<IBufferResource> createBuffer(IDevice* device, int size, void* initialData)
{
    ...
    GFX_CHECK_CALL_ABORT(device->createBufferResource(bufferDesc, initialData, outBuffer.writeRef())
    );
    return outBuffer;
}
...
void formatTestsImpl(IDevice* device, UnitTestContext* context)
{
...

    {
        ...
        compareComputeResult(
            device,
            intResults,
            Slang::makeArray<int32_t>(127, 0, 0, 127, 0, 127, 0, 127, 0, 0, 127, 127, 0, 0, 0, 127)
        );
    }
...

    {
        ...
        compareComputeResult(
            device,
            floatResults,
            Slang::makeArray<float>(1.0f, 0.0f, 0.0f, 1.0f, 1.0f, 1.0f, 0.499992371f, 0.499992371f)
        );
    }
    ...
    {
        uint8_t texData[] =
            {98u, 238u, 232u, 77u, 240u, 66u, 148u, 31u, 124u, 95u, 2u, 224u, 255u, 107u, 77u, 250u
            };
        ITextureResource::SubresourceData subData = {(void*)texData, 16, 0};
