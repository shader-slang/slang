...
namespace
{
    ...
    void transitionResourceStates(IDevice* device)
    {
        ...
        ResourceState currentTextureState = ResourceState::CopySource;
        ResourceState currentBufferState = ResourceState::CopySource;
...
//                     currentTextureState = nextState;
    ...
    void supportedResourceStatesTestImpl(IDevice* device, UnitTestContext* context)
    {
        ...
        texDesc.allowedStates = ResourceStateSet(ResourceState::UnorderedAccess);
