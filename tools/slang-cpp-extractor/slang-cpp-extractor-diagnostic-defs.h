...
DIAGNOSTIC(100006, Error, outputAlreadyDefined, "Output is already defined '$0'")

DIAGNOSTIC(100007, Error, requireValueAfterOption, "Require a value after $0 option")

DIAGNOSTIC(100008, Error, unknownOption, "Unknown option '$0'")

DIAGNOSTIC(100009, Error, noInputPathsSpecified, "No input paths specified")

DIAGNOSTIC(100009, Error, noOutputPathSpecified, "No -o output path specified")
