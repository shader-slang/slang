...
static SlangResult
_read(JSONContainer* container, const String& json, DiagnosticSink* sink, SourceMap& outSourceMap)
{
...
static SlangResult
_write(JSONContainer* container, const SourceMap& sourceMap, DiagnosticSink* sink, String& out)
{
    // Write it out
    JSONValue jsonValue;
