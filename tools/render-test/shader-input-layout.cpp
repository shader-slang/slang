...
struct ShaderInputLayoutParser
{
    ...
    SlangResult
    parseOption(Misc::TokenReader& parser, String const& word, ShaderInputLayout::TextureVal* val)
    {
        if (word == "depth")
        {
    ...
    SlangResult
    parseOption(Misc::TokenReader& parser, String const& word, ShaderInputLayout::SamplerVal* val)
    {
    ...
    SlangResult
    parseOption(Misc::TokenReader& parser, String const& word, ShaderInputLayout::DataValBase* val)
    {
        if (word == "data")
        {
            parser.Read("=");
    ...
    SlangResult
    parseOption(Misc::TokenReader& parser, String const& word, ShaderInputLayout::BufferVal* val)
    {
        if (word == "stride")
        {
            parser.Read("=");
    ...
    SlangResult
    parseOption(Misc::TokenReader& parser, String const& word, ShaderInputLayout::ObjectVal* val)
    {
        if (word == "type")
        {
            parser.Read("=");
    ...
    RefPtr<ShaderInputLayout::Val>
    parseNumericValExpr(Misc::TokenReader& parser, bool negate = false)
    {
    ...
    void parseLine(Misc::TokenReader& parser)
    {
        ...
        else if (parser.LookAhead("globalSpecializationArg") || parser.LookAhead("global_type") ||
    ...
    switch (desc.format)
    {
        ...
        case Format::R64_UINT:
        {
            generateTextureDataWithTargetTStorage<
                uint64_t>(output, desc, formatInfo, loadDataIntoUint<uint64_t>);
            break;
        }
        ...
        {
            generateTextureDataWithTargetTStorage<
                uint32_t>(output, desc, formatInfo, loadDataIntoUint<uint32_t>);
            break;
        }
        ...
        {
            generateTextureDataWithTargetTStorage<
                uint16_t>(output, desc, formatInfo, loadDataIntoUint<uint16_t>);
            break;
        }
        case Format::R8_UINT:
        ...
        {
            generateTextureDataWithTargetTStorage<
                uint8_t>(output, desc, formatInfo, loadDataIntoUint<uint8_t>);
            break;
        }
        case Format::R64_SINT:
        {
            generateTextureDataWithTargetTStorage<
                int64_t>(output, desc, formatInfo, loadDataIntoInt<int64_t>);
            break;
        }
        ...
        {
            generateTextureDataWithTargetTStorage<
                int32_t>(output, desc, formatInfo, loadDataIntoInt<int32_t>);
            break;
        }
        ...
        {
            generateTextureDataWithTargetTStorage<
                int16_t>(output, desc, formatInfo, loadDataIntoInt<int16_t>);
            break;
        }
        case Format::R8_SINT:
        ...
        {
            generateTextureDataWithTargetTStorage<
                int8_t>(output, desc, formatInfo, loadDataIntoInt<int8_t>);
            break;
        }
        default:
        {
