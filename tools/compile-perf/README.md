...
| **interface_depth**                           | a linear interface inheritance chain `N` deep, conformance at the bottom    | **calcInheritanceInfo vs interface-hierarchy depth** (~N^3 measured)                                                                                                                                                                                                                                                             | `SemanticChecking`                       |
