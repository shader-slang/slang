...
| **diagnostics_clean**     | `N` functions with distinct compile-time constants, no errors                                                                                                                             | **size-matched control** — `errors − clean` isolates diagnostic cost                                                                                                          | `SemanticChecking`                                  |
