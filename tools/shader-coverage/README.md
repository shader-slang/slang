...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------- | ------------------------------------- |
| CPU source                                | Supported. End-to-end runtime dispatch with counter readback is validated by the `coverageCpuRuntimeDispatch` unit test; the direct-host binding recipe is documented in `docs/design/shader-coverage-host-interface.md`.                                                                        | (no-op — backend uses uniform offsets) | (no-op)                               |
