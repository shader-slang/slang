...
public:
    ...
    static SlangResult
    createFactory(DeviceCheckFlags flags, Slang::ComPtr<IDXGIFactory>& outFactory);
...
struct D3DAccelerationStructureInputsBuilder
{
    ...
    Slang::Result
    build(const IAccelerationStructure::BuildInputs& buildInputs, IDebugCallback* callback);
