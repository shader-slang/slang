...
/* static */DXGI_FORMAT D3DUtil::getMapFormat(Format format)
{
    switch (format)
    {
        case Format::RGBA_Typeless32:            return DXGI_FORMAT_R32G32B32A32_TYPELESS;
        case Format::RGB_Typeless32:             return DXGI_FORMAT_R32G32B32_TYPELESS;
        case Format::RG_Typeless32:              return DXGI_FORMAT_R32G32_TYPELESS;
        case Format::R_Typeless32:               return DXGI_FORMAT_R32_TYPELESS;

        case Format::RGBA_Typeless16:            return DXGI_FORMAT_R16G16B16A16_TYPELESS;
        case Format::RG_Typeless16:              return DXGI_FORMAT_R16G16_TYPELESS;
        case Format::R_Typeless16:               return DXGI_FORMAT_R16_TYPELESS;

        case Format::RGBA_Typeless8:             return DXGI_FORMAT_R8G8B8A8_TYPELESS;
        case Format::RG_Typeless8:               return DXGI_FORMAT_R8G8_TYPELESS;
        case Format::R_Typeless8:                return DXGI_FORMAT_R8_TYPELESS;
        case Format::BGRA_Typeless8:             return DXGI_FORMAT_B8G8R8A8_TYPELESS;
        ...
        case Format::RGBA_UInt32:                return DXGI_FORMAT_R32G32B32A32_UINT;
        case Format::RGB_UInt32:                 return DXGI_FORMAT_R32G32B32_UINT;
        case Format::RG_UInt32:                  return DXGI_FORMAT_R32G32_UINT;
        case Format::R_UInt32:                   return DXGI_FORMAT_R32_UINT;

        case Format::RGBA_UInt16:                return DXGI_FORMAT_R16G16B16A16_UINT;
        case Format::RG_UInt16:                  return DXGI_FORMAT_R16G16_UINT;
        case Format::R_UInt16:                   return DXGI_FORMAT_R16_UINT;
    
        case Format::RGBA_UInt8:                 return DXGI_FORMAT_R8G8B8A8_UINT;
        case Format::RG_UInt8:                   return DXGI_FORMAT_R8G8_UINT;
        case Format::R_UInt8:                    return DXGI_FORMAT_R8_UINT;

        case Format::RGBA_SInt32:                return DXGI_FORMAT_R32G32B32A32_SINT;
        case Format::RGB_SInt32:                 return DXGI_FORMAT_R32G32B32_SINT;
        case Format::RG_SInt32:                  return DXGI_FORMAT_R32G32_SINT;
        case Format::R_SInt32:                   return DXGI_FORMAT_R32_SINT;

        case Format::RGBA_SInt16:                return DXGI_FORMAT_R16G16B16A16_SINT;
        case Format::RG_SInt16:                  return DXGI_FORMAT_R16G16_SINT;
        case Format::R_SInt16:                   return DXGI_FORMAT_R16_SINT;

        case Format::RGBA_SInt8:                 return DXGI_FORMAT_R8G8B8A8_SINT;
        case Format::RG_SInt8:                   return DXGI_FORMAT_R8G8_SINT;
        case Format::R_SInt8:                    return DXGI_FORMAT_R8_SINT;

        case Format::RGBA_Unorm_UInt16:          return DXGI_FORMAT_R16G16B16A16_UNORM;
        case Format::RG_Unorm_UInt16:            return DXGI_FORMAT_R16G16_UNORM;
        case Format::R_Unorm_UInt16:             return DXGI_FORMAT_R16_UNORM;

        case Format::RGBA_Unorm_UInt8:           return DXGI_FORMAT_R8G8B8A8_UNORM;
        case Format::RGBA_Unorm_UInt8_Srgb:      return DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
        case Format::RG_Unorm_UInt8:             return DXGI_FORMAT_R8G8_UNORM;
        ...
        case Format::D_Unorm16:                  return DXGI_FORMAT_D16_UNORM;

        case Format::BGRA_Unorm4:                return DXGI_FORMAT_B4G4R4A4_UNORM;
        ...
        case Format::BC6_Unsigned:               return DXGI_FORMAT_BC6H_UF16;
        case Format::BC6_Signed:                 return DXGI_FORMAT_BC6H_SF16;
