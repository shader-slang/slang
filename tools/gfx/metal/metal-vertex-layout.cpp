...
NS::SharedPtr<MTL::VertexDescriptor>
InputLayoutImpl::createVertexDescriptor(NS::UInteger vertexBufferIndexOffset)
{
    ...
    for (Index i = 0; i < m_vertexStreams.getCount(); i++)
    {
        ...
        desc->setStepRate(
            vertexStream.slotClass == InputSlotClass::PerVertex ? 1
