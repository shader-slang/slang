...
SlangResult DeviceImpl::initialize(const Desc& desc)
{
...

    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateQuery(
    ...
    size_t* outPixelSize)
{
    ...
    // Now just read back texels from the staging textures
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_immediateContext->Map(stagingTexture, 0, D3D11_MAP_READ, 0, &mappedResource));
...
Result DeviceImpl::createTextureResource(const ITextureResource::Desc& descIn, const ITextureResource::SubresourceData* initData, ITextureResource** outResource)
{
    ...
    case IResource::Type::Texture1D:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateTexture1D(&desc, subResourcesPtr, texture1D.writeRef()));
    ...
    case IResource::Type::Texture2D:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateTexture2D(&desc, subResourcesPtr, texture2D.writeRef()));
    ...
    case IResource::Type::Texture3D:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateTexture3D(&desc, subResourcesPtr, texture3D.writeRef()));
...
Result DeviceImpl::createBufferResource(const IBufferResource::Desc& descIn, const void* initData, IBufferResource** outResource)
{
    ...
    SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateBuffer(&bufferDesc, initData ? &subResourceData : nullptr, buffer->m_buffer.writeRef()));
    ...
    if (srcDesc.memoryType == MemoryType::ReadBack || bufferDesc.Usage != D3D11_USAGE_DYNAMIC)
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateBuffer(&bufDesc, nullptr, buffer->m_staging.writeRef()));
    }
...
Result DeviceImpl::createSamplerState(ISamplerState::Desc const& desc, ISamplerState** outSampler)
{
    ...
    SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateSamplerState(
        &dxDesc,
        sampler.writeRef()));
...
Result DeviceImpl::createTextureView(ITextureResource* texture, IResourceView::Desc const& desc, IResourceView** outView)
{
    ...
    case IResourceView::Type::RenderTarget:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateRenderTargetView(resourceImpl->m_resource, nullptr, rtv.writeRef()));
    ...
    case IResourceView::Type::DepthStencil:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateDepthStencilView(resourceImpl->m_resource, nullptr, dsv.writeRef()));
    ...
    case IResourceView::Type::UnorderedAccess:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateUnorderedAccessView(resourceImpl->m_resource, nullptr, uav.writeRef()));
    ...
    case IResourceView::Type::ShaderResource:
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateShaderResourceView(resourceImpl->m_resource, &srvDesc, srv.writeRef()));
    ...
    IResourceView** outView)
{
    ...
    case IResourceView::Type::UnorderedAccess:
    {
        ...
        ComPtr<ID3D11UnorderedAccessView> uav;
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateUnorderedAccessView(resourceImpl->m_buffer, &uavDesc, uav.writeRef()));
    ...
    case IResourceView::Type::ShaderResource:
    {
        ...
        ComPtr<ID3D11ShaderResourceView> srv;
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateShaderResourceView(resourceImpl->m_buffer, &srvDesc, srv.writeRef()));
...
Result DeviceImpl::createInputLayout(IInputLayout::Desc const& desc, IInputLayout** outLayout)
{
    ...
    SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateInputLayout(&inputElements[0], (UINT)inputElementCount, vertexShaderBlob->GetBufferPointer(), vertexShaderBlob->GetBufferSize(),
    ...
    const IShaderProgram::Desc& desc, IShaderProgram** outProgram, ISlangBlob** outDiagnosticBlob)
{
    ...
    for (SlangUInt i = 0; i < entryPointCount; i++)
    {
        ...
        case SLANG_STAGE_COMPUTE:
            ...
            SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateComputeShader(
        ...
        case SLANG_STAGE_VERTEX:
            SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateVertexShader(
                kernelCode->getBufferPointer(),
                kernelCode->getBufferSize(),
                nullptr,
        ...
        case SLANG_STAGE_FRAGMENT:
            SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreatePixelShader(
                kernelCode->getBufferPointer(),
                kernelCode->getBufferSize(),
                nullptr,
...
#define FACE(DST, SRC) \
    ...
    /* end */
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateDepthStencilState(
            &dsDesc,
    ...
    ComPtr<ID3D11RasterizerState> rasterizerState;
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateRasterizerState(
            &rsDesc,
    ...
    ComPtr<ID3D11BlendState> blendState;
    {
        ...
        SLANG_RETURN_ON_FAIL_HRESULT(m_device->CreateBlendState(
            &dstDesc,
            blendState.writeRef()));
    }
