...
struct AutoDiffTexture : public WindowedAppBase
{
    ...
    gfx::Result
    loadComputeProgram(gfx::IDevice* device, const char* fileName, gfx::IShaderProgram** outProgram)
    {
        ComPtr<slang::ISession> slangSession;
        slangSession = device->getSlangSession();
    ...
    ComPtr<gfx::ITextureResource>
    createRenderTargetTexture(gfx::Format format, int w, int h, int levels)
    {
    ...
    ComPtr<gfx::IPipelineState>
    createRenderPipelineState(IInputLayout* inputLayout, IShaderProgram* program)
    {
    ...
    void
    renderImage(int transientHeapIndex, IFramebuffer* fb, const SetupPipelineFunc& setupPipeline)
    {
    ...
    virtual void renderFrame(int frameBufferIndex) override
    {
        ...
        // Barriers.
        {
            ...
            resEncoder
                ->textureBarrier(gRefImage, ResourceState::Present, ResourceState::ShaderResource);
        ...
        // Propagete gradients through mip map layers from top (lowest res) to bottom (highest res).
        {
            ...
            encoder
                ->textureBarrier(gIterImage, ResourceState::Present, ResourceState::ShaderResource);
