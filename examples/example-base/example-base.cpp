...
Slang::Result
WindowedAppBase::initializeBase(const char* title, int width, int height, DeviceType deviceType)
{
...
ComPtr<gfx::IResourceView>
WindowedAppBase::createTextureFromFile(String fileName, int& textureWidth, int& textureHeight)
{
