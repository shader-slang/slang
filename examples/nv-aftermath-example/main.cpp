...
gfx::Result
AftermathCrashExample::loadShaderProgram(gfx::IDevice* device, gfx::IShaderProgram** outProgram)
{
...
{
    reinterpret_cast<AftermathCrashExample*>(pUserData)
        ->onAftermathMarker(marker, resolvedMarkerData, markerSize);
}
