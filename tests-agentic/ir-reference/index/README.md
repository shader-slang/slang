...
| Image/buffer/sampler/atomic/raytracing/wave opcodes -- see `tests-agentic/ir-reference/resources-and-atomics/`. | out-of-bundle | (unspecified) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| Autodiff opcodes (differential pairs, forward/backward differentiate) -- see `tests-agentic/ir-reference/differentiation/`. | out-of-bundle | (unspecified) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| Individual decoration semantics (the ~180 decoration opcodes catalog) -- see `tests-agentic/ir-reference/decorations/`. The index bundle anchors only the **fact** that decorations attach to instructions; it does not catalog individual decoration semantics. | out-of-bundle | (unspecified) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| `block`, `param` (block-parameter role), branches, terminators, `Require*` markers -- see `tests-agentic/ir-reference/control-flow/`. | out-of-bundle | [#block](../../../docs/llm-generated/ir-reference/index.md#block) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| Per-opcode type catalog (`IntType`, `StructuredBufferType`, vector/matrix types, ...) -- see `tests-agentic/ir-reference/types/`. | out-of-bundle | [#inttype](../../../docs/llm-generated/ir-reference/index.md#inttype) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| `Layout`, `Attr`, `Debug*`, `SPIRVAsmOperand` -- see `tests-agentic/ir-reference/metadata/`. | out-of-bundle | [#layout](../../../docs/llm-generated/ir-reference/index.md#layout) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| Structural opcodes (`module`, `func`, `generic`, `global_var`, `global_param`, `struct`, `interface`, `witness_table`, `key`, `field`, `lookupWitness`) catalog -- see `tests-agentic/ir-reference/structure/`. | out-of-bundle | [#module](../../../docs/llm-generated/ir-reference/index.md#module) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
| `nop`, `Unrecognized`, type queries, size/alignment, storage casts, liveness markers, descriptor heaps, kernel launch -- see `tests-agentic/ir-reference/misc/`. | out-of-bundle | [#nop](../../../docs/llm-generated/ir-reference/index.md#nop) | Covered by a sibling bundle; see the appropriate `tests-agentic/<sibling>/` directory. |
