...
| --- | --- | --- | --- |
| **`global_generic_param`** — a `GenericTypeParamDecl` at module level (not nested under a `generic` parent) is non-trivial to produce from natural Slang surface code. | (unclassified) | [#globalgenericparam](../../../docs/llm-generated/ir-reference/structure.md#globalgenericparam) | Not reachable via any allowed test directive. |
| **`SymbolAlias`** — per the doc, `(synthesized as part of linking)`; not observable at LOWER-TO-IR. The doc itself notes "No `SymbolAlias` should survive past linking". | (unclassified) | [#symbolalias](../../../docs/llm-generated/ir-reference/structure.md#symbolalias) | Not reachable via any allowed test directive. |
| **`thisTypeWitness`** — `(synthesized inside InterfaceDecl lowering)`; not portably observable in a stable dump form. | (unclassified) | [#thistypewitness](../../../docs/llm-generated/ir-reference/structure.md#thistypewitness) | Not reachable via any allowed test directive. |
| **`module` / `ModuleInst`** — observable only as the implicit preamble that wraps every IR dump. There is no anchor inside an IR dump that uniquely identifies the module instruction in a FileCheck-able way without coupling to dump preamble formatting. | implementation-detail | [#module](../../../docs/llm-generated/ir-reference/structure.md#module) | Not reachable via any allowed test directive. |
| **`global_hashed_string_literals`** — `(synthesized)` container; no natural surface anchor. | link-stage-only | [#globalhashedstringliterals](../../../docs/llm-generated/ir-reference/structure.md#globalhashedstringliterals) | Not reachable via any allowed test directive. |
| **`indexedFieldKey`** — `(synthesized)`; the doc lists no AST origin and the natural surface (tuple-like field access) does not produce it portably at LOWER-TO-IR. | link-stage-only | [#indexedfieldkey](../../../docs/llm-generated/ir-reference/structure.md#indexedfieldkey) | Not reachable via any allowed test directive. |
| **`TypeEqualityWitness`** — `(synthesized)`; no AST origin. | link-stage-only | [#typeequalitywitness](../../../docs/llm-generated/ir-reference/structure.md#typeequalitywitness) | Not reachable via any allowed test directive. |
