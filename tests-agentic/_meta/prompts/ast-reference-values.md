# Prompt: tests-agentic/ast-reference/values/
...
Produce the test bundle at `tests-agentic/ast-reference/values/`,
anchored to
...
- `tests-agentic/ast-reference/types/` — covers the **`Type`**
...
- `tests-agentic/ast-reference/declarations/` — covers the **`Decl`**
  ...
  here.
- `tests-agentic/ast-reference/expressions/` — covers expressions
...
- `tests-agentic/ast-reference/modifiers.md` — covers AST modifiers.
  ...
  duplicate.
- `tests-agentic/ir-reference/types/` — covers the IR-level
  observations. Do not re-test IR spellings here; this bundle
  stays at the AST / type-checker surface (interpreter values and
  diagnostics).
- `tests-agentic/pipeline/03-semantic-check/` — covers
  type-coercion mechanics. The `TypeCoercionWitness` family's
  surface lives there.
- `tests-agentic/language-feature/generics-and-packs/` (future) —
  pack / variadic claims.
- `tests-agentic/language-feature/autodiff/` (future) — autodiff
...
- `docs/llm-generated/ir-reference/types.md` (cross-link only)
