# Prompt: tests-agentic/pipeline/05-ir-passes/
...
Produce the test bundle at `tests-agentic/pipeline/05-ir-passes/`,
anchored to
...
([04-ast-to-ir](../../../docs/llm-generated/pipeline/04-ast-to-ir.md))
and code emission
([06-emit](../../../docs/llm-generated/pipeline/06-emit.md)). The
...
diff before vs after the pass), or the *consequence* of the pass on
...
- The pre-link region documented in
  [04b-pre-link-passes.md](../../../docs/llm-generated/pipeline/04b-pre-link-passes.md);
