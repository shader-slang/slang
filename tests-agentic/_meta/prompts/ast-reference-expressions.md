# Prompt: tests-agentic/ast-reference/expressions/
...
Produce the test bundle at `tests-agentic/ast-reference/expressions/`,
anchored to
...
- `tests-agentic/pipeline/02-parse-ast/` covers **parse-stage**
...
- `tests-agentic/pipeline/03-semantic-check/` covers **checker-stage**
...
- `tests-agentic/ast-reference/base/` covers the abstract-base-class
