# Prompt: tests-agentic/syntax-reference/grammar/
...
Produce the test bundle at `tests-agentic/syntax-reference/grammar/`,
anchored to
...
- `docs/llm-generated/syntax-reference/tokens.md` — for terminal
...
- `docs/llm-generated/pipeline/02-parse-ast.md` — for the
