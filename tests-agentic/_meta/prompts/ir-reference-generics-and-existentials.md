# Prompt: tests-agentic/ir-reference/generics-and-existentials/
...
`tests-agentic/ir-reference/generics-and-existentials/`, anchored to
...
- `docs/llm-generated/ir-reference/generics-and-existentials.md`
...
- `extractExistentialType(%i)` has result type `Type` (not the
  concrete type — the concrete type is the *value* it returns).
