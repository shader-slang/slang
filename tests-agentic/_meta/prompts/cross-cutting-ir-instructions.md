# Prompt: tests-agentic/cross-cutting/ir-instructions/
...
Produce the test bundle at `tests-agentic/cross-cutting/ir-instructions/`,
anchored to
...
- `docs/llm-generated/ir-reference/control-flow.md`
