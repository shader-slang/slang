...
| **`DynamicSubtypeWitness`** — "evidence used for `DynamicType` dispatch". `DynamicType` is not user-spellable (it is produced by existential elimination); recorded under types.md's out-of-scope list. The witness has no distinct user-observable surface. | (unclassified) | [#dynamicsubtypewitness](../../../docs/llm-generated/ast-reference/values.md#dynamicsubtypewitness) | Reason and explanation to be refined by the next regeneration. |
| **`ExtractExistentialSubtypeWitness`** — "evidence carried by an opened existential value". Observable through the existential / `some IFoo` surface, which belongs to the existential-feature bundle. | (unclassified) | [#extractexistentialsubtypewitness](../../../docs/llm-generated/ast-reference/values.md#extractexistentialsubtypewitness) | Reason and explanation to be refined by the next regeneration. |
| **Pack / variadic IntVals and SubtypeWitnesses**: `FirstIntVal`, `LastIntVal`, `ConcreteIntValPack`, `TrimFirstIntValPack`, `TrimLastIntValPack`, `ShapeConcatIntValPack`, `ShapePermuteIntValPack`, `ShapeSwapIntValPack`, `ShapeReduceIntValPack`, `ExpandIntValPack`, `EachIntVal`, `TypePackSubtypeWitness`, `EachSubtypeWitness`, `FirstSubtypeWitness`, `LastSubtypeWitness`, `TrimFirstSubtypeWitness`, `TrimLastSubtypeWitness`, `PackBranchSubtypeWitness`, `ExpandSubtypeWitness`, `NonEmptyPackWitness`. These are observable through the pack-expression / variadic-generic feature; that surface belongs to the `language-feature/generics-and-packs` bundle (or the expressions bundle's pack tests). | (unclassified) | [#firstintval](../../../docs/llm-generated/ast-reference/values.md#firstintval) | Reason and explanation to be refined by the next regeneration. |
| **`FuncCallIntVal`** — the doc names it but does not give a surface spelling. Recorded as a doc gap above. | (unclassified) | [#funccallintval](../../../docs/llm-generated/ast-reference/values.md#funccallintval) | Reason and explanation to be refined by the next regeneration. |
| **`HasDiffTypeInfoWitness`**, **`DiffTypeInfoWitness`**, **`HigherOrderDiffTypeTranslationWitness`** — autodiff-specific witnesses; their surface belongs to the autodiff bundle. | (unclassified) | [#hasdifftypeinfowitness](../../../docs/llm-generated/ast-reference/values.md#hasdifftypeinfowitness) | Reason and explanation to be refined by the next regeneration. |
...
| **Abstract intermediates** named in the doc: `IntVal`, `SizeOfLikeIntVal`, `ShapeTransformIntValPack`, `Witness`, `SubtypeWitness`, `TypeCoercionWitness`. These produce no user spelling of their own; only their concrete descendants are user-anchorable. | (unclassified) | [#intval](../../../docs/llm-generated/ast-reference/values.md#intval) | Reason and explanation to be refined by the next regeneration. |
| **Singleton-ness of `NoneWitness`** (and any other zero-operand Val): hash-cons makes it one-per-`ASTBuilder`, but the surface cannot distinguish two `Val*` from one. | (unclassified) | [#nonewitness](../../../docs/llm-generated/ast-reference/values.md#nonewitness) | Reason and explanation to be refined by the next regeneration. |
| **Operand-list layout** described under `## Nodes` ("operand semantics" column). The `m_operands: List<ValNodeOperand>` storage and the indices each concrete class uses are not visible at the surface. | (unclassified) | [#operand-semantics](../../../docs/llm-generated/ast-reference/values.md#operand-semantics) | Reason and explanation to be refined by the next regeneration. |
| **Polynomial helpers** (`PolynomialIntValFactor`, `PolynomialIntValTerm`) — the operands of `PolynomialIntVal`; no user-observable surface distinct from `PolynomialIntVal` itself. | (unclassified) | [#polynomialintvalfactor](../../../docs/llm-generated/ast-reference/values.md#polynomialintvalfactor) | Reason and explanation to be refined by the next regeneration. |
| **`SNormModifierVal`**, **`NoDiffModifierVal`** — additional type-level modifier Vals. `unorm` is exercised (`unormmodifierval-resource-format.slang`); `snorm` / `no_diff` share the same modifier-survival observation and are not duplicated here. `no_diff` in particular belongs to the autodiff bundle. | (unclassified) | [#snormmodifierval](../../../docs/llm-generated/ast-reference/values.md#snormmodifierval) | Reason and explanation to be refined by the next regeneration. |
| **`TypeCastIntVal`** — no surface-distinct spelling from a plain cast in an array bound. Recorded as a doc gap. | (unclassified) | [#typecastintval](../../../docs/llm-generated/ast-reference/values.md#typecastintval) | Reason and explanation to be refined by the next regeneration. |
| **`TypeEqualityWitness`** — surface-observable as "two type aliases yield interchangeable values". That observation is owned by `ast-reference/types`'s `NamedExpressionType` / typedef tests (or by the `pipeline/03-semantic-check` bundle's equality rules). Not duplicated here. | (unclassified) | [#typeequalitywitness](../../../docs/llm-generated/ast-reference/values.md#typeequalitywitness) | Reason and explanation to be refined by the next regeneration. |
| **`UIntSetVal`** — "a hash-consed bitset used by the capability system". The capability system has its own bundle; the bitset identity has no direct user-spelling. | (unclassified) | [#uintsetval](../../../docs/llm-generated/ast-reference/values.md#uintsetval) | Reason and explanation to be refined by the next regeneration. |
| **Differentiation `Val`s**: `DifferentiateVal`, `ForwardDifferentiateVal`, `BackwardDifferentiateVal`, `BackwardDifferentiateIntermediateTypeVal`, `BackwardDifferentiatePrimalVal`, `BackwardDifferentiatePropagateVal`. Observable through the autodiff feature; that surface belongs to the autodiff bundle. | (unclassified) | [#val](../../../docs/llm-generated/ast-reference/values.md#val) | Reason and explanation to be refined by the next regeneration. |
