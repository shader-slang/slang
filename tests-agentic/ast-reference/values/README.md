...
| --- | --- | --- | --- |
| **The `## Family hierarchy` mermaid diagram itself.** | (unclassified) | (unspecified) | Not reachable via any allowed test directive. |
| **`DirectDeclRef` / `MemberDeclRef` / `LookupDeclRef`** as distinct surface observations. The doc's distinction is internal ("how the declaration was reached"); a plain identifier or a qualified member reference looks the same at the type-checker surface. | (unclassified) | [#directdeclref](../../../docs/llm-generated/ast-reference/values.md#directdeclref) | Only `GenericAppDeclRef`'s presence of generic arguments is user-distinguishable. |
| **`DynamicSubtypeWitness`** — "evidence used for `DynamicType` dispatch". `DynamicType` is not user-spellable (it is produced by existential elimination); recorded under types.md's out-of-scope list. The witness has no distinct user-observable surface. | (unclassified) | [#dynamicsubtypewitness](../../../docs/llm-generated/ast-reference/values.md#dynamicsubtypewitness) | Not reachable via any allowed test directive. |
| **`ExtractExistentialSubtypeWitness`** — "evidence carried by an opened existential value". Observable through the existential / `some IFoo` surface, which belongs to the existential-feature bundle. | (unclassified) | [#extractexistentialsubtypewitness](../../../docs/llm-generated/ast-reference/values.md#extractexistentialsubtypewitness) | Not reachable via any allowed test directive. |
| **Pack / variadic IntVals and SubtypeWitnesses**: `FirstIntVal`, `LastIntVal`, `ConcreteIntValPack`, `TrimFirstIntValPack`, `TrimLastIntValPack`, `ShapeConcatIntValPack`, `ShapePermuteIntValPack`, `ShapeSwapIntValPack`, `ShapeReduceIntValPack`, `ExpandIntValPack`, `EachIntVal`, `TypePackSubtypeWitness`, `EachSubtypeWitness`, `FirstSubtypeWitness`, `LastSubtypeWitness`, `TrimFirstSubtypeWitness`, `TrimLastSubtypeWitness`, `PackBranchSubtypeWitness`, `ExpandSubtypeWitness`, `NonEmptyPackWitness`. These are observable through the pack-expression / variadic-generic feature; that surface belongs to the `language-feature/generics-and-packs` bundle (or the expressions bundle's pack tests). | (unclassified) | [#firstintval](../../../docs/llm-generated/ast-reference/values.md#firstintval) | Not reachable via any allowed test directive. |
| **`FuncCallIntVal`** — the doc names it but does not give a surface spelling. Recorded as a doc gap above. | (unclassified) | [#funccallintval](../../../docs/llm-generated/ast-reference/values.md#funccallintval) | Not reachable via any allowed test directive. |
| **`HasDiffTypeInfoWitness`**, **`DiffTypeInfoWitness`**, **`HigherOrderDiffTypeTranslationWitness`** — autodiff-specific witnesses; their surface belongs to the autodiff bundle. | (unclassified) | [#hasdifftypeinfowitness](../../../docs/llm-generated/ast-reference/values.md#hasdifftypeinfowitness) | Not reachable via any allowed test directive. |
| **Hash-cons identity / `Val*` pointer equality** described under [`### Hash-consing and the ASTBuilder`](../../../docs/llm-generated/ast-reference/values.md#hash-consing-and-the-astbuilder). Surface tests can only observe behavioral equivalence (e.g. that two specializations of a generic with the same argument are interchangeable); pointer equality of two `Val*` is not visible. This bundle's `genericappdeclref-same-args-compatible.slang` exercises the **observable** form of this invariant. | (unclassified) | [#hash-consing-and-the-astbuilder](../../../docs/llm-generated/ast-reference/values.md#hash-consing-and-the-astbuilder) | Not reachable via any allowed test directive. |
| **Abstract intermediates** named in the doc: `IntVal`, `SizeOfLikeIntVal`, `ShapeTransformIntValPack`, `Witness`, `SubtypeWitness`, `TypeCoercionWitness`. These produce no user spelling of their own; only their concrete descendants are user-anchorable. | (unclassified) | [#intval](../../../docs/llm-generated/ast-reference/values.md#intval) | Not reachable via any allowed test directive. |
| **Singleton-ness of `NoneWitness`** (and any other zero-operand Val): hash-cons makes it one-per-`ASTBuilder`, but the surface cannot distinguish two `Val*` from one. | (unclassified) | [#nonewitness](../../../docs/llm-generated/ast-reference/values.md#nonewitness) | Not reachable via any allowed test directive. |
| **Operand-list layout** described under `## Nodes` ("operand semantics" column). The `m_operands: List<ValNodeOperand>` storage and the indices each concrete class uses are not visible at the surface. | (unclassified) | [#operand-semantics](../../../docs/llm-generated/ast-reference/values.md#operand-semantics) | Not reachable via any allowed test directive. |
| **Polynomial helpers** (`PolynomialIntValFactor`, `PolynomialIntValTerm`) — the operands of `PolynomialIntVal`; no user-observable surface distinct from `PolynomialIntVal` itself. | (unclassified) | [#polynomialintvalfactor](../../../docs/llm-generated/ast-reference/values.md#polynomialintvalfactor) | Not reachable via any allowed test directive. |
| **`SNormModifierVal`**, **`NoDiffModifierVal`** — additional type-level modifier Vals. `unorm` is exercised (`unormmodifierval-resource-format.slang`); `snorm` / `no_diff` share the same modifier-survival observation and are not duplicated here. `no_diff` in particular belongs to the autodiff bundle. | (unclassified) | [#snormmodifierval](../../../docs/llm-generated/ast-reference/values.md#snormmodifierval) | Not reachable via any allowed test directive. |
| **`TypeCastIntVal`** — no surface-distinct spelling from a plain cast in an array bound. Recorded as a doc gap. | (unclassified) | [#typecastintval](../../../docs/llm-generated/ast-reference/values.md#typecastintval) | Not reachable via any allowed test directive. |
| **`TypeEqualityWitness`** — surface-observable as "two type aliases yield interchangeable values". That observation is owned by `ast-reference/types`'s `NamedExpressionType` / typedef tests (or by the `pipeline/03-semantic-check` bundle's equality rules). Not duplicated here. | (unclassified) | [#typeequalitywitness](../../../docs/llm-generated/ast-reference/values.md#typeequalitywitness) | Not reachable via any allowed test directive. |
| **`UIntSetVal`** — "a hash-consed bitset used by the capability system". The capability system has its own bundle; the bitset identity has no direct user-spelling. | (unclassified) | [#uintsetval](../../../docs/llm-generated/ast-reference/values.md#uintsetval) | Not reachable via any allowed test directive. |
| **Differentiation `Val`s**: `DifferentiateVal`, `ForwardDifferentiateVal`, `BackwardDifferentiateVal`, `BackwardDifferentiateIntermediateTypeVal`, `BackwardDifferentiatePrimalVal`, `BackwardDifferentiatePropagateVal`. Observable through the autodiff feature; that surface belongs to the autodiff bundle. | (unclassified) | [#val](../../../docs/llm-generated/ast-reference/values.md#val) | Not reachable via any allowed test directive. |
| **`WitnessLookupIntVal`** — same as `FuncCallIntVal`; no surface spelling documented. Recorded as a doc gap. | (unclassified) | [#witnesslookupintval](../../../docs/llm-generated/ast-reference/values.md#witnesslookupintval) | Not reachable via any allowed test directive. |
