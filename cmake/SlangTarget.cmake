function(slang_add_target dir type)
  ...
  cmake_parse_arguments(ARG "${no_value_args}" "${single_value_args}"
                        "${multi_value_args}" ${ARGV})
  ...
  elseif(ARG_TEST_TOOL)
    ...
    file(RELATIVE_PATH dir_source_relative ${CMAKE_SOURCE_DIR} ${dir_absolute})
  ...
  foreach(inc ${ARG_INCLUDE_DIRECTORIES_PUBLIC})
    ...
    target_include_directories(${target} PUBLIC "$<BUILD_INTERFACE:${inc_abs}>")
  endforeach()
