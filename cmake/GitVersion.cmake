...
function(get_git_version var_numeric var dir)
    if(NOT DEFINED ${var})
        ...
        # First, try reading from VERSION file
        ...
        if(EXISTS "${version_file}")
            ...
            if(NOT version_file_content MATCHES "^\\$Format:" AND
               version_file_content MATCHES "^v20[2-9][0-9]\\.[0-9]")
                ...
                message(STATUS "Using version from VERSION file: ${version_out}")
            endif()
        endif()

        # If VERSION file didn't provide a valid version, try git describe
        if(NOT version_out)
