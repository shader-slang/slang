...
struct TypeTextUtil
{
    ...
    static SlangResult
    findDebugInfoFormat(const Slang::UnownedStringSlice& text, SlangDebugInfoFormat& out);
    ...
    static SlangResult
    findPassThrough(const UnownedStringSlice& slice, SlangPassThrough& outPassThrough);
