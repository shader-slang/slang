...
public:
    ...
    virtual SLANG_NO_THROW SlangResult SLANG_MCALL
    enumeratePathContents(const char* path, FileSystemContentsCallBack callback, void* userData)
        SLANG_OVERRIDE;
...
SlangResult
ZipFileSystemImpl::_findEntryIndexFromFixedPath(const String& fixedPath, mz_uint& outIndex)
{
...
SlangResult
ZipFileSystemImpl::getFileUniqueIdentity(const char* path, ISlangBlob** outUniqueIdentity)
{
