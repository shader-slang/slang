...
/* static */ SlangSourceLanguage
TypeConvertUtil::getSourceLanguageFromTarget(SlangCompileTarget target)
{
    switch (target)
    {
        case SLANG_GLSL:
...
/* static */ SlangCompileTarget
TypeConvertUtil::getCompileTargetFromSourceLanguage(SlangSourceLanguage lang)
{
    switch (lang)
    {
