...
struct SemanticVersion
{
    ...
    static SlangResult
    parse(const UnownedStringSlice& value, char separatorChar, SemanticVersion& outVersion);
...
struct MatchSemanticVersion
{
    ...
    findAnyBest(const SemanticVersion* versions, Count count, const ThisType& matchVersion);
