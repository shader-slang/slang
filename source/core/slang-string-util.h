...
struct StringUtil
{
    ...
    /// in does.
    static void
    split(const UnownedStringSlice& in, char splitChar, List<UnownedStringSlice>& slicesOut);
    ...
    static void
    splitOnWhitespace(const UnownedStringSlice& in, List<UnownedStringSlice>& slicesOut);

    /// Split in, by specified splitChar append into slices out
    /// Slices contents will directly address into in, so contents will only stay valid as long as
    /// in does.
    static void
    appendSplit(const UnownedStringSlice& in, char splitChar, List<UnownedStringSlice>& slicesOut);
    /// Split in by the specified splitSlice
    /// Slices contents will directly address into in, so contents will only stay valid as long as
    /// in does.
    ...
    static void
    appendSplitOnWhitespace(const UnownedStringSlice& in, List<UnownedStringSlice>& slicesOut);
    ...
    static void
    join(const List<String>& in, const UnownedStringSlice& separator, StringBuilder& out);

    static void
    join(const UnownedStringSlice* values, Index valueCount, char separator, StringBuilder& out);
    static void join(
    ...
    static Index
    indexOfInSplit(const UnownedStringSlice& in, char splitChar, const UnownedStringSlice& find);
    ...
    getAtInSplit(const UnownedStringSlice& in, char splitChar, Index index);
    ...
    static String
    replaceAll(UnownedStringSlice text, UnownedStringSlice subStr, UnownedStringSlice replacement);
