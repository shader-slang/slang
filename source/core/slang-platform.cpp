...
/* static */ void
SharedLibrary::calcPlatformPath(const UnownedStringSlice& path, StringBuilder& outPath)
{
...
/* static */ SlangResult
SharedLibrary::loadWithPlatformPath(char const* platformFileName, SharedLibrary::Handle& handleOut)
{
    handleOut = nullptr;
...
/* static */ void
SharedLibrary::appendPlatformFileName(const UnownedStringSlice& name, StringBuilder& dst)
{
    dst.append(name);
    dst.append(".dll");
}
...
/* static */ SlangResult
SharedLibrary::loadWithPlatformPath(char const* platformFileName, Handle& handleOut)
{
    handleOut = nullptr;
    // Work around
...
/* static */ SlangResult
PlatformUtil::getEnvironmentVariable(const UnownedStringSlice& name, StringBuilder& out)
{
