...
struct CommandOptions
{
    ...
    add(const char* name,
        ...
        UserValue userValue = kInvalidUserValue);
    void
    add(const UnownedStringSlice* names,
        Count namesCount,
        const char* usage,
        const char* description,
        UserValue userValue = kInvalidUserValue,
    ...
    void
    addValue(const char* name, const char* description, UserValue userValue = kInvalidUserValue);
    ...
    void
    splitUsage(const UnownedStringSlice& usageSlice, List<UnownedStringSlice>& outSlices) const;
...
protected:
    ...
    SlangResult
    _addValueName(const UnownedStringSlice& name, Index categoryIndex, Index targetIndex);
