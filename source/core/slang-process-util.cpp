...
/* static */ SlangResult
ProcessUtil::execute(const CommandLine& commandLine, ExecuteResult& outExecuteResult)
{
...
/* static */ SlangResult
ProcessUtil::readUntilTermination(Process* process, ExecuteResult& outExecuteResult)
{
    List<Byte> stdOut;
    List<Byte> stdError;
...
/* static */ SlangResult
ProcessUtil::readUntilTermination(Process* process, List<Byte>* outStdOut, List<Byte>* outStdError)
{
