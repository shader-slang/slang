...
static const TypeTextUtil::CompileTargetInfo s_compileTargetInfos[] = {
    ...
    {SLANG_LLVM_HOST_ASSEMBLY, "ll", "llvm-host-ir,llvm-ir", "LLVM IR assembly (host style)"},
    {SLANG_LLVM_HOST_OBJECT_CODE, "o", "llvm-host-obj,llvm-obj", "Object code compiled with LLVM (host style)"},
    {SLANG_LLVM_HOST_HOST_CALLABLE, "", "llvm-host-host-callable", "Host callable via LLVM (host style)"},
    {SLANG_LLVM_SHADER_ASSEMBLY, "ll", "llvm-shader-ir", "LLVM IR assembly (shader style)"},
    {SLANG_LLVM_SHADER_OBJECT_CODE, "o", "llvm-shader-obj", "Object code compiled with LLVM (shader style)"},
    {SLANG_LLVM_SHADER_HOST_CALLABLE, "", "llvm-shader-host-callable", "Host callable via LLVM (shader style)"},
};
