...
{
    static void
    ctorArray(RttiTypeFuncsMap* typeMap, const RttiInfo* rttiInfo, void* in, Index count)
    {
    ...
    static void
    dtorArray(RttiTypeFuncsMap* typeMap, const RttiInfo* rttiInfo, void* in, Index count)
    {
        SLANG_UNUSED(typeMap);
        SLANG_UNUSED(rttiInfo);
        T* dst = (T*)in;
...
SLANG_FORCE_INLINE StructRttiInfo::Flags
combine(StructRttiInfo::Flags flags, RttiDefaultValue defaultValue)
{
