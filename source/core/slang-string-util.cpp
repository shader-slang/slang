...
/* static */void StringUtil::camelCaseToLowerDashed(const UnownedStringSlice& in, StringBuilder& out)
{
...
/* static */void StringUtil::snakeCaseToLowerDashed(const UnownedStringSlice& inSlice, StringBuilder& out)
{
...
/* static */void StringUtil::snakeCaseToUpperCamel(const UnownedStringSlice& in, StringBuilder& out)
{
    const char*const end = in.end();
...
/* static */void StringUtil::dashedToUpperSnake(const UnownedStringSlice& in, StringBuilder& out)
{
