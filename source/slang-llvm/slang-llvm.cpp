...
SlangResult
LLVMDownstreamCompiler::convert(IArtifact* from, const ArtifactDesc& to, IArtifact** outArtifact)
{
...
SlangResult
LLVMDownstreamCompiler::compile(const CompileOptions& inOptions, IArtifact** outArtifact)
{
        ...
        case SLANG_SHADER_HOST_CALLABLE:
        {
...

            {
                ...
                if (stdcLibExpected)
                {
                    ...
                    {
                        static const NameAndFunc funcs[] = {SLANG_LLVM_FUNCS(SLANG_LLVM_FUNC
