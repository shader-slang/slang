...
Slice<UnownedStringSlice> ArtifactPostEmitMetadata::getExportedFunctionMangledNames()
{
    return Slice<UnownedStringSlice>(m_exportedFunctionMangledNames.getBuffer(), m_exportedFunctionMangledNames.getCount());
}
