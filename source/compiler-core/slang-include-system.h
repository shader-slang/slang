...
{
    SlangResult
    findFile(const String& pathToInclude, const String& pathIncludedFrom, PathInfo& outPathInfo);
    ...
    SlangResult
    loadFile(const PathInfo& pathInfo, ComPtr<ISlangBlob>& outBlob, SourceFile*& outSourceFile);
