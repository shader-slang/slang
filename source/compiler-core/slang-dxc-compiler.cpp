...
SlangResult DXCDownstreamCompiler::init(ISlangSharedLibrary* library)
{
    ...
    SLANG_RETURN_ON_FAIL(
        m_createInstance(CLSID_DxcCompiler, __uuidof(dxcCompiler), (LPVOID*)dxcCompiler.writeRef())
    );
...
SlangResult
DXCDownstreamCompiler::convert(IArtifact* from, const ArtifactDesc& to, IArtifact** outArtifact)
{
