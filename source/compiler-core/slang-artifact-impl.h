...
public:
    ...
    virtual ICastable* SLANG_MCALL findAssociatedWithPredicate(ICastableList::FindFunc findFunc, void* data) SLANG_OVERRIDE;
    ...
    virtual void* SLANG_MCALL findRepresentation(const Guid& guid) SLANG_OVERRIDE;
