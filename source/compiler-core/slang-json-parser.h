...
public:
    ...
    virtual void
    addLexemeValue(JSONTokenType type, const UnownedStringSlice& value, SourceLoc loc) = 0;
...
public:
    SlangResult
    parse(JSONLexer* lexer, SourceView* sourceView, JSONListener* listener, DiagnosticSink* sink);
