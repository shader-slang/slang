...
/* static */ TerminatedCharSlice
SliceUtil::toTerminatedCharSlice(SliceAllocator& allocator, ISlangBlob* blob)
{
...
/* static */ TerminatedCharSlice
SliceUtil::toTerminatedCharSlice(StringBuilder& storage, ISlangBlob* blob)
{
    TerminatedCharSlice slice;
    if (SliceUtil::getTerminated(blob, slice))
    {
