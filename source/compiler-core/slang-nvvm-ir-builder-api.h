...
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_IS_FIRST_LANE ((SlangNVVMBuilderFeature_3)43u)
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_ANY_TRUE ((SlangNVVMBuilderFeature_3)44u)
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_ALL_TRUE ((SlangNVVMBuilderFeature_3)45u)
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_ALL_EQUAL_INT ((SlangNVVMBuilderFeature_3)46u)
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_ALL_EQUAL_UINT ((SlangNVVMBuilderFeature_3)47u)
#define SLANG_NVVM_BUILDER_FEATURE_WAVE_MASK_ALL_EQUAL_FLOAT ((SlangNVVMBuilderFeature_3)48u)
#define SLANG_NVVM_BUILDER_FEATURE_COUNT_3 49u
...
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_IS_FIRST_LANE ((SlangNVVMIntrinsicOp_3)9u)
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_ANY_TRUE ((SlangNVVMIntrinsicOp_3)10u)
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_ALL_TRUE ((SlangNVVMIntrinsicOp_3)11u)
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_ALL_EQUAL_INT ((SlangNVVMIntrinsicOp_3)12u)
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_ALL_EQUAL_UINT ((SlangNVVMIntrinsicOp_3)13u)
#define SLANG_NVVM_INTRINSIC_OP_WAVE_MASK_ALL_EQUAL_FLOAT ((SlangNVVMIntrinsicOp_3)14u)
...
#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_IS_FIRST_LANE_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE

#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_ANY_TRUE_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE

#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_ALL_TRUE_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE

#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_ALL_EQUAL_INT_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE

#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_ALL_EQUAL_UINT_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE

#define SLANG_NVVM_BUILDER_API_V3_WAVE_MASK_ALL_EQUAL_FLOAT_MIN_SIZE \
    SLANG_NVVM_BUILDER_API_V3_WAVE_LANE_INDEX_MIN_SIZE
