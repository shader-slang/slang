...
struct NameConventionUtil
{
    ...
    static void
    split(NameStyle nameStyle, const UnownedStringSlice& slice, List<UnownedStringSlice>& out);
    ...
    static void
    convert(const UnownedStringSlice& slice, NameConvention toConvention, StringBuilder& out);
};
