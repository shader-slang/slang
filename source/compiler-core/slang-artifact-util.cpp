...
/* static */ ComPtr<IArtifact>
ArtifactUtil::createArtifact(const ArtifactDesc& desc, const char* name)
{
...
/* static */ ComPtr<IArtifact>
ArtifactUtil::createArtifactForCompileTarget(SlangCompileTarget target)
{
...
static SlangResult
_calcInferred(IArtifact* artifact, const UnownedStringSlice& basePath, StringBuilder& outPath)
{
...
/* static */ IArtifact*
ArtifactUtil::findArtifactByName(IArtifact* artifact, FindStyle findStyle, const char* name)
{
    return findArtifactByPredicate(artifact, findStyle, _isName, const_cast<char*>(name));
}

/* static */ IArtifact*
ArtifactUtil::findArtifactByDesc(IArtifact* artifact, FindStyle findStyle, const ArtifactDesc& desc)
{
...
/* static */ void
ArtifactUtil::addAssociated(IArtifact* artifact, IArtifactPostEmitMetadata* metadata)
{
    if (metadata)
    {
...
/* static */ void
ArtifactUtil::addAssociated(IArtifact* artifact, IArtifactDiagnostics* diagnostics)
{
    if (diagnostics)
    {
