...
/* static */ ArtifactPayload
ArtifactDescUtil::getPayloadForSourceLanaguage(SlangSourceLanguage language)
{
    switch (language)
    {
        default:
...
/* static */ String
ArtifactDescUtil::getBaseNameFromPath(const ArtifactDesc& desc, const UnownedStringSlice& path)
{
...
/* static */ String
ArtifactDescUtil::getBaseNameFromName(const ArtifactDesc& desc, const UnownedStringSlice& inName)
{
    String name(inName);
...
/* static */ String
ArtifactDescUtil::getBaseName(const ArtifactDesc& desc, IPathArtifactRepresentation* pathRep)
{
