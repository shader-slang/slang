...
SlangResult
TintDownstreamCompiler::compile(IArtifact* const sourceArtifact, IArtifact** outArtifact)
{
...
SlangResult
TintDownstreamCompiler::convert(IArtifact* from, const ArtifactDesc& to, IArtifact** outArtifact)
{
