...
struct DownstreamCompilerUtil : public DownstreamCompilerUtilBase
{
    ...
    static IDownstreamCompiler*
    findCompiler(const List<IDownstreamCompiler*>& compilers, const DownstreamCompilerDesc& desc);
    ...
    static void
    setDefaultLocators(DownstreamCompilerLocatorFunc outFuncs[int(SLANG_PASS_THROUGH_COUNT_OF)]);
