...
SlangResult
FileSystemContents::find(ISlangFileSystemExt* fileSystem, const UnownedStringSlice& inPath)
{
    clear();
...
/* static */ SlangResult
ArtifactContainerUtil::writeContainer(IArtifact* artifact, const String& fileName)
{
...
SlangResult
ArtifactContainerReader::read(ISlangFileSystemExt* fileSystem, ComPtr<IArtifact>& outArtifact)
{
    m_fileSystem = fileSystem;
...
)
{
    ...
    {
        SLANG_RETURN_ON_FAIL(
            _readContainerDirectory(associatedIndex, IArtifact::ContainedKind::Associated, artifact)
        );
    }
...
SlangResult
ArtifactContainerUtil::readContainer(IArtifact* artifact, ComPtr<IArtifact>& outArtifact)
{
...
/* static */ SlangResult
ArtifactContainerUtil::filter(IArtifact* artifact, ComPtr<IArtifact>& outArtifact)
{
    outArtifact.setNull();
