...
// macOS coverage runs tests in-process, so replay exceptions can be thrown
// across the slang dylib boundary and caught in the test executable. Export
// the exception classes on non-Windows platforms so their RTTI has default
// visibility. MSVC does not need this and rejects some dll-interface patterns
// used by these internal exception classes.
