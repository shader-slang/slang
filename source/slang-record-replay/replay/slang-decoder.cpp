...
)
{
    ...
    {
        consumer
            ->IGlobalSession_setDownstreamCompilerPath(objectId, passThrough, path.getPointer());
    }
}
...
void SlangDecoder::IGlobalSession_compileStdLib(
    ObjectID objectId,
    ParameterBlock const& parameterBlock
)
{
...
void SlangDecoder::IGlobalSession_loadStdLib(
    ObjectID objectId,
    ParameterBlock const& parameterBlock
)
{
...
void SlangDecoder::IGlobalSession_saveStdLib(
    ObjectID objectId,
    ParameterBlock const& parameterBlock
)
{
...
)
{
    ...
    {
        consumer
            ->ICompositeComponentType_link(objectId, outLinkedComponentTypeId, outDiagnosticsId);
    }
}
...
)
{
    ...
    {
        consumer
            ->ITypeConformance_renameEntryPoint(objectId, newName.getPointer(), outEntryPointId);
    }
}
