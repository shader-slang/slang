...
public:
    ...
    void
    IGlobalSession_createCompileRequest(ObjectID objectId, ParameterBlock const& parameterBlock);
    void IGlobalSession_addBuiltins(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    IGlobalSession_setSharedLibraryLoader(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    IGlobalSession_getSharedLibraryLoader(ObjectID objectId, ParameterBlock const& parameterBlock);
    void IGlobalSession_checkCompileTargetSupport(
        ObjectID objectId,
        ParameterBlock const& parameterBlock
    );
    void
    IGlobalSession_checkPassThroughSupport(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    IGlobalSession_getCompilerElapsedTime(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    IGlobalSession_setSPIRVCoreGrammar(ObjectID objectId, ParameterBlock const& parameterBlock);
    void IGlobalSession_parseCommandLineArguments(
        ObjectID objectId,
        ParameterBlock const& parameterBlock
    );
    void
    IGlobalSession_getSessionDescDigest(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    ISession_loadModuleFromSourceString(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    ISession_createCompositeComponentType(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    IModule_getSpecializationParamCount(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    IEntryPoint_getEntryPointHostCallable(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    ICompositeComponentType_getSession(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    ICompositeComponentType_getTargetCode(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    ICompositeComponentType_specialize(ObjectID objectId, ParameterBlock const& parameterBlock);
    ...
    void
    ITypeConformance_getEntryPointCode(ObjectID objectId, ParameterBlock const& parameterBlock);
    void ITypeConformance_getTargetCode(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    ITypeConformance_getResultAsFileSystem(ObjectID objectId, ParameterBlock const& parameterBlock);
    void
    ITypeConformance_getEntryPointHash(ObjectID objectId, ParameterBlock const& parameterBlock);
