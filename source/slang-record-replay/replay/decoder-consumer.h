...
public:
    ...
    virtual void
    IGlobalSession_createCompileRequest(ObjectID objectId, ObjectID outCompileRequest) = 0;
    ...
    virtual void
    IGlobalSession_checkCompileTargetSupport(ObjectID objectId, SlangCompileTarget target) = 0;
    virtual void
    IGlobalSession_checkPassThroughSupport(ObjectID objectId, SlangPassThrough passThrough) = 0;
    virtual void
    IGlobalSession_compileStdLib(ObjectID objectId, slang::CompileStdLibFlags flags) = 0;
    virtual void
    IGlobalSession_loadStdLib(ObjectID objectId, const void* stdLib, size_t stdLibSizeInBytes) = 0;
    virtual void IGlobalSession_saveStdLib(
        ObjectID objectId,
    ...
    virtual void
    ISession_getTypeRTTIMangledName(ObjectID objectId, ObjectID typeId, ObjectID outNameBlobId) = 0;
    ...
    virtual void
    ISession_getLoadedModule(ObjectID objectId, SlangInt index, ObjectID outModuleId) = 0;

    virtual void ISession_isBinaryModuleUpToDate(ObjectID objectId) { (void)objectId; }

    // IModule
    virtual void
    IModule_findEntryPointByName(ObjectID objectId, char const* name, ObjectID outEntryPointId) = 0;

    virtual void IModule_getDefinedEntryPointCount(ObjectID objectId) { (void)objectId; }

    virtual void
    IModule_getDefinedEntryPoint(ObjectID objectId, SlangInt32 index, ObjectID outEntryPointId) = 0;
    ...
    virtual void
    IModule_renameEntryPoint(ObjectID objectId, const char* newName, ObjectID outEntryPointId) = 0;
