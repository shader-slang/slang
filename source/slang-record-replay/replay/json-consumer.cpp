...
static inline void
_writePair(Slang::StringBuilder& builder, int indent, T const& name, U const& value)
{
    _writeIndent(builder, indent);
    builder << name << ": " << value << ",\n";
}
...
template<typename T, typename U>
static inline void
_writePairNoComma(Slang::StringBuilder& builder, int indent, T const& name, U const& value)
{
    _writeIndent(builder, indent);
    builder << name << ": " << value << "\n";
}
...
)
{
...

    {
        ScopeWritterForKey scopeWritter(&builder, &indent, functionName);
        {
            ...
            {
                ScopeWritterForKey
                    scopeWritterForArgs(&builder, &indent, "specializationArgs", false);
...
void JsonConsumer::IGlobalSession_loadStdLib(
    ObjectID objectId,
    const void* stdLib,
...
void JsonConsumer::IGlobalSession_saveStdLib(
    ObjectID objectId,
...
)
{
...

    {
        ...
        );
        {
            ...
            {
                ScopeWritterForKey
                    scopeWritterForComponentTypes(&builder, &indent, "componentTypes", false);
