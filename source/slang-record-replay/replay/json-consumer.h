...
public:
    ...
    virtual void
    IGlobalSession_addBuiltins(ObjectID objectId, char const* sourcePath, char const* sourceString);
    ...
    virtual void
    IGlobalSession_checkCompileTargetSupport(ObjectID objectId, SlangCompileTarget target);
    virtual void
    IGlobalSession_checkPassThroughSupport(ObjectID objectId, SlangPassThrough passThrough);
    virtual void IGlobalSession_compileStdLib(ObjectID objectId, slang::CompileStdLibFlags flags);
    virtual void
    IGlobalSession_loadStdLib(ObjectID objectId, const void* stdLib, size_t stdLibSizeInBytes);
    virtual void
    IGlobalSession_saveStdLib(ObjectID objectId, SlangArchiveType archiveType, ObjectID outBlobId);
    ...
    virtual void
    ISession_getTypeRTTIMangledName(ObjectID objectId, ObjectID typeId, ObjectID outNameBlobId);
    ...
    // IModule
    virtual void
    IModule_findEntryPointByName(ObjectID objectId, char const* name, ObjectID outEntryPointId);

    virtual void IModule_getDefinedEntryPointCount(ObjectID objectId) { (void)objectId; }

    virtual void
    IModule_getDefinedEntryPoint(ObjectID objectId, SlangInt32 index, ObjectID outEntryPointId);
    ...
    virtual void
    IModule_link(ObjectID objectId, ObjectID outLinkedComponentTypeId, ObjectID outDiagnosticsId);
    ...
    virtual void
    IModule_renameEntryPoint(ObjectID objectId, const char* newName, ObjectID outEntryPointId);
    ...
    virtual void
    IEntryPoint_renameEntryPoint(ObjectID objectId, const char* newName, ObjectID outEntryPointId);
