...
{
    FunctionHeader* pHeader =
        const_cast<FunctionHeader*>(reinterpret_cast<const FunctionHeader*>(m_memoryStream.getData()
        ));
...
{
    FunctionTailer* pTailer =
        const_cast<FunctionTailer*>(reinterpret_cast<const FunctionTailer*>(m_memoryStream.getData()
        ));
