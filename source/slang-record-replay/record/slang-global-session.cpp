...
SLANG_NO_THROW SlangResult SLANG_MCALL
GlobalSessionRecorder::compileStdLib(slang::CompileStdLibFlags flags)
{
    slangRecordLog(LogLevel::Verbose, "%p: %s\n", m_actualGlobalSession.get(), __PRETTY_FUNCTION__);
    ...
    {
        recorder = m_recordManager->beginMethodRecord(
            ApiCallId::IGlobalSession_compileStdLib,
            m_globalSessionHandle
        );
...
SLANG_NO_THROW SlangResult SLANG_MCALL
GlobalSessionRecorder::loadStdLib(const void* stdLib, size_t stdLibSizeInBytes)
{
    slangRecordLog(LogLevel::Verbose, "%p: %s\n", m_actualGlobalSession.get(), __PRETTY_FUNCTION__);
    ...
    {
        recorder = m_recordManager->beginMethodRecord(
            ApiCallId::IGlobalSession_loadStdLib,
            m_globalSessionHandle
        );
...
SLANG_NO_THROW SlangResult SLANG_MCALL
GlobalSessionRecorder::saveStdLib(SlangArchiveType archiveType, ISlangBlob** outBlob)
{
    slangRecordLog(LogLevel::Verbose, "%p: %s\n", m_actualGlobalSession.get(), __PRETTY_FUNCTION__);
    ...
    {
        recorder = m_recordManager->beginMethodRecord(
            ApiCallId::IGlobalSession_saveStdLib,
            m_globalSessionHandle
        );
