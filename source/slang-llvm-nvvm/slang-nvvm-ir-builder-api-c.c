...
typedef SlangNVVMBuilderAPI_V3 SlangNVVMBuilderAPIV3CCompileProbe;
typedef char SlangNVVMBuilderAPIV3MinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V3_MIN_SIZE <= sizeof(SlangNVVMBuilderAPI_V3)) ? 1 : -1];
typedef char SlangNVVMBuilderFeatureCapacityCCompileProbe
    [((SLANG_NVVM_BUILDER_FEATURE_WORD_COUNT_3 * 64u) >= SLANG_NVVM_BUILDER_FEATURE_COUNT_3) ? 1
                                                                                             : -1];
...
typedef char SlangNVVMBuilderAPIV2ScalarIntegerBitNotCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_BIT_NOT_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_BIT_XOR_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerNegateMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NEGATE_MIN_SIZE <= sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerNegateCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NEGATE_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_BIT_NOT_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2RelaxedGlobalI32AtomicAddMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_RELAXED_GLOBAL_I32_ATOMIC_ADD_MIN_SIZE <=
      sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2RelaxedGlobalI32AtomicAddCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_RELAXED_GLOBAL_I32_ATOMIC_ADD_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NEGATE_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerEqualMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_EQUAL_MIN_SIZE <= sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerEqualCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_EQUAL_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_RELAXED_GLOBAL_I32_ATOMIC_ADD_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerNotEqualMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NOT_EQUAL_MIN_SIZE <= sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerNotEqualCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NOT_EQUAL_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_EQUAL_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerSignedGreaterThanMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_THAN_MIN_SIZE <=
      sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerSignedGreaterThanCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_THAN_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_NOT_EQUAL_MIN_SIZE)
         ? 1
         : -1];
...
typedef char SlangNVVMBuilderAPIV2ScalarIntegerSignedLessEqualCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_LESS_EQUAL_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_THAN_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerSignedGreaterEqualMinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_EQUAL_MIN_SIZE <=
      sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2ScalarIntegerSignedGreaterEqualCapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_EQUAL_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_LESS_EQUAL_MIN_SIZE)
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2RawRWStructuredBufferI32MinimumSizeCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_RAW_RW_STRUCTURED_BUFFER_I32_MIN_SIZE <=
      sizeof(SlangNVVMBuilderAPI_V2))
         ? 1
         : -1];
typedef char SlangNVVMBuilderAPIV2RawRWStructuredBufferI32CapabilityOrderCCompileProbe
    [(SLANG_NVVM_BUILDER_API_V2_RAW_RW_STRUCTURED_BUFFER_I32_MIN_SIZE >
      SLANG_NVVM_BUILDER_API_V2_SCALAR_INTEGER_SIGNED_GREATER_EQUAL_MIN_SIZE)
         ? 1
         : -1];
