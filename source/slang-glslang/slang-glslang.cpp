...
//
// A new exported entry point must also be added to slang-glslang.map, or ELF builds will not export
// it and the client's lookup returns null. Some call sites do not null-check.
