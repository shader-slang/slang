...
public:
    ...
    virtual void
    emitStructFieldAttributes(IRStructType* /* structType */, IRStructField* /* field */) {};
    ...
    void
    ensureGlobalInst(ComputeEmitActionsContext* ctx, IRInst* inst, EmitAction::Level requiredLevel);
    ...
    static IRNumThreadsDecoration*
    getComputeThreadGroupSize(IRFunc* func, Int outNumThreads[kThreadGroupAxisCount]);
...
protected:
    ...
    virtual void
    emitParameterGroupImpl(IRGlobalParam* varDecl, IRUniformParameterGroupType* type) = 0;
    virtual void
    emitEntryPointAttributesImpl(IRFunc* irFunc, IREntryPointDecoration* entryPointDecor) = 0;
