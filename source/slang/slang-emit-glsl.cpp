...
SlangResult GLSLSourceEmitter::init()
{
    ...
    if (getTargetProgram()->getOptionSet().getBoolOption(CompilerOptionName::GLSLForceScalarLayout))
    {
...
void GLSLSourceEmitter::_emitGLSLStructuredBuffer(IRGlobalParam* varDecl, IRHLSLStructuredBufferTypeBase* structuredBufferType)
{
    ...
    case kIROp_DefaultBufferLayoutType:
        m_writer->emit(getTargetProgram()->getOptionSet().getBoolOption(CompilerOptionName::GLSLForceScalarLayout) ? "scalar" : "std430");
        break;
...
void GLSLSourceEmitter::_emitGLSLParameterGroup(IRGlobalParam* varDecl, IRUniformParameterGroupType* type)
{
    ...
    */
    ...
    else
    {
        ...
        m_writer->emit("layout(");
        m_writer->emit(getTargetProgram()->getOptionSet().getBoolOption(CompilerOptionName::GLSLForceScalarLayout) ? "scalar" : "std140");
