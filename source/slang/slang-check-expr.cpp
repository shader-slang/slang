...
static DeclVisibility _getTypeVisibility(
    Type* type,
    SmallDictionary<Type*, DeclVisibility>& typeVisibilityCache)
{
...
{
    // SmallDictionary rather than Dictionary: most types checked here have little or no shared
    // structure, so the cache typically ends up with only a handful of entries. See the
    // SmallDictionary doc comment and #12139.
    SmallDictionary<Type*, DeclVisibility> typeVisibilityCache;
