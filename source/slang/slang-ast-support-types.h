...
namespace Slang
{
    ...
    enum : ConversionCost
    {
        ...
        // Additional conversion cost to add when casting matrix to vector and vise versa, 1/2 loads, 1/2 stores
        kConversionCost_MatrixToVector = 3,
        kConversionCost_VectorToMatrix = 3,
