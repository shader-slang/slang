...
public:
    ...
    /// do a conversion)
    SerialIndex
    addSerialArray(size_t elementSize, size_t alignment, const void* elements, Index elementCount);
...
protected:
    ...
    SerialIndex
    _addStringSlice(SerialTypeKind typeKind, SliceMap& sliceMap, const UnownedStringSlice& slice);
...
SLANG_FORCE_INLINE void
toSerialValue(SerialWriter* writer, const NATIVE_TYPE& src, SERIAL_TYPE& dst)
{
...
SLANG_FORCE_INLINE void
toNativeValue(SerialReader* reader, const SERIAL_TYPE& src, NATIVE_TYPE& dst)
{
