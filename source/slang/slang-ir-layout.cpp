...
IRSizeAndAlignmentDecoration*
findSizeAndAlignmentDecorationForLayout(IRType* type, IRTypeLayoutRuleName layoutName)
{
...
IROffsetDecoration*
findOffsetDecorationForLayout(IRStructField* field, IRTypeLayoutRuleName layoutName)
{
...
struct NaturalLayoutRules : IRTypeLayoutRules
{
    ...
    virtual IRSizeAndAlignment
    getVectorSizeAndAlignment(IRSizeAndAlignment element, IRIntegerValue count)
    {
...
Result
getNaturalOffset(CompilerOptionSet& optionSet, IRStructField* field, IRIntegerValue* outOffset)
{
...
Result
getStd430Offset(CompilerOptionSet& optionSet, IRStructField* field, IRIntegerValue* outOffset)
{
