...
public:
    ...
    IRMatrixType*
    getMatrixType(IRType* elementType, IRInst* rowCount, IRInst* columnCount, IRInst* layout);
    ...
    getDifferentialPairUserCodeType(IRType* valueType, IRInst* witnessTable);
    ...
    IRFuncType*
    getFuncType(UInt paramCount, IRType* const* paramTypes, IRType* resultType, IRAttr* attribute);
    ...
    IRType*
    getBoundInterfaceType(IRType* interfaceType, IRType* concreteType, IRInst* witnessTable);
    ...
    IRInst*
    addDifferentiableTypeEntry(IRInst* dictDecoration, IRInst* irType, IRInst* conformanceWitness);
    ...
    IRInst*
    emitSpecializeInst(IRType* type, IRInst* genericVal, UInt argCount, IRInst* const* args);
    ...
    IRInst*
    emitTargetTupleGetElement(IRType* elementType, IRInst* targetTupleVal, IRInst* indexVal);
    ...
    IRInst*
    emitMakeExistentialWithRTTI(IRType* type, IRInst* value, IRInst* witnessTable, IRInst* rtti);

    IRInst*
    emitWrapExistential(IRType* type, IRInst* value, UInt slotArgCount, IRInst* const* slotArgs);

    IRInst*
    emitWrapExistential(IRType* type, IRInst* value, UInt slotArgCount, IRUse const* slotArgs)
    {
    ...
    createInterfaceRequirementEntry(IRInst* requirementKey, IRInst* requirementVal);
    ...
    createGLSLShaderStorableBufferType(UInt operandCount, IRInst* const* operands);
    ...
    IRInst*
    emitSwizzle(IRType* type, IRInst* base, UInt elementCount, IRInst* const* elementIndices);
    ...
    IRInst*
    emitSwizzledStore(IRInst* dest, IRInst* source, UInt elementCount, UInt const* elementIndices);
    ...
    IRDecoration*
    addBindExistentialSlotsDecoration(IRInst* value, UInt argCount, IRInst* const* args);
    ...
    IRDecoration*
    addDecoration(IRInst* value, IROp op, IRInst* operand0, IRInst* operand1, IRInst* operand2)
    {
    ...
    IRDecoration*
    addTargetSystemValueDecoration(IRInst* value, UnownedStringSlice sysValName, UInt index = 0)
    {
    ...
    IRSemanticDecoration*
    addSemanticDecoration(IRInst* value, UnownedStringSlice const& text, int index = 0)
    {
...
inline IRTargetIntrinsicDecoration*
findBestTargetIntrinsicDecoration(IRInst* inInst, CapabilitySet const& targetCaps)
{
