        ...
        case OptionKind::EmitSeparateDebug:
            {
                ...
                // a .dbg.spv file.
                // This needs to override any obfuscation and debug info flags.
                // We now want to output SPIRV with full debug info and no obfuscation.
                // The main output SPIRV will have all debug info stripped, and obfuscation
                // is not needed as this only changes names which will now not be present.
                m_compileRequest->setDebugInfoLevel(SLANG_DEBUG_INFO_LEVEL_MAXIMAL);
                linkage->m_optionSet.set(OptionKind::Obfuscate, false);
