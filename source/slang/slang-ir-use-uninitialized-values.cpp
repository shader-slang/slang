...
static void
collectInstructionByUsage(List<IRInst*>& stores, List<IRInst*>& loads, IRInst* user, IRInst* inst)
{
...
static void
cancelLoads(ReachabilityContext& reachability, const List<IRInst*>& stores, List<IRInst*>& loads)
{
...
static List<IRInst*>
getUnresolvedParamLoads(ReachabilityContext& reachability, IRFunc* func, IRInst* inst)
{
...
static List<IRStructField*>
checkFieldsFromExit(ReachabilityContext& reachability, IRReturn* ret, IRStructType* type)
{
