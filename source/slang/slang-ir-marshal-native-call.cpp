...
IRFuncType*
NativeCallMarshallingContext::getNativeFuncType(IRBuilder& builder, IRFuncType* declaredFuncType)
{
...
IRFunc*
NativeCallMarshallingContext::generateDLLExportWrapperFunc(IRBuilder& builder, IRFunc* originalFunc)
{
