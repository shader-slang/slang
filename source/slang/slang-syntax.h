...
List<ExtensionDecl*> const&
getCandidateExtensions(DeclRef<AggTypeDecl> const& declRef, SemanticsVisitor* semantics);
...
inline FilteredMemberRefList<VarDecl>
getFields(ASTBuilder* astBuilder, DeclRef<StructDecl> declRef, MemberFilterStyle filterStyle)
{
...
DeclRef<StructDecl>
findBaseStructDeclRef(ASTBuilder* astBuilder, DeclRef<StructDecl> structTypeDeclRef);
...
inline FilteredMemberRefList<ParamDecl>
getParameters(ASTBuilder* astBuilder, DeclRef<CallableDecl> declRef)
{
...
GenericDeclRefType*
getGenericDeclRefType(ASTBuilder* astBuilder, DeclRef<GenericDecl> const& declRef);
