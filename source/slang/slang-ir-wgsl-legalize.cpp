...
IRInst*
LegalizeWGSLEntryPointContext::tryConvertValue(IRBuilder& builder, IRInst* val, IRType* toType)
{
...
)
{
    ...
    switch (result.wgslSystemValueNameEnum)
    {
        ...
        {
            m_sink
                ->diagnose(parentVar, Diagnostics::unimplementedSystemValueSemantic, semanticName);
            return result;
        }
    }
...
LegalizeWGSLEntryPointContext::collectSystemValFromEntryPoint(EntryPointInfo entryPoint)
{
