...
//    cases of its own here: the peephole pass folds the DescriptorHandle
//    representation round-trip away before this pass runs, leaving the
//    plain getElement(heap, index) shape the cases below already handle.
