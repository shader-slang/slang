...
bool isVaryingParameter(IRVarLayout* varLayout)
{
    ...
    // If the base cases above failed, we need should check if we are dealing with
    // a IRVarLayout that could have "nested" IRVarLayouts, such as a IRStructTypeLayout.
