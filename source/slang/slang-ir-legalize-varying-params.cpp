...
protected:
    ...
    //
    LegalizedVaryingVal
    createLegalVaryingVal(IRType* type, IRVarLayout* varLayout, LayoutResourceKind kind)
    {
...
struct CUDAEntryPointVaryingParamLegalizeContext : EntryPointVaryingParamLegalizeContext
{
    ...
    IRInst*
    emitOptiXAttributeFetch(int& ioBaseAttributeIndex, IRType* typeToFetch, IRBuilder* builder)
    {
        ...
        else if (auto arrayType = as<IRArrayTypeBase>(typeToFetch))
        {
            ...
            return builder
                ->emitMakeArray(typeToFetch, elementVals.getCount(), elementVals.getBuffer());
        }
        ...
        else if (auto vecType = as<IRVectorType>(typeToFetch))
        {
            ...
            return builder
                ->emitMakeVector(typeToFetch, elementVals.getCount(), elementVals.getBuffer());
        }
