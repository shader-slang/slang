...
public:
    ...
    void
    zeroBasedUTF16LocToOneBasedUTF8Loc(Index inLine, Index inCol, Index& outLine, Index& outCol);
    ...
    void offsetToLineCol(Index offset, Index& line, Index& col)
    {
        auto firstGreater = std::upper_bound(
            ...
            lines.end(),
            offset,
            [this](Index first, UnownedStringSlice second) { return first < getLineStart(second); }
        );
