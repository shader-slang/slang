...
public:
    ...
    template<typename T>
    DeclRef<T>
    getDirectDeclRef(T* decl, typename std::enable_if_t<std::is_base_of_v<Decl, T>>* = nullptr)
    {
    ...
    getMatrixType(Type* elementType, IntVal* rowCount, IntVal* colCount, IntVal* layout);
    ...
    getDifferentialPtrPairType(Type* valueType, Witness* diffRefTypeWitness);
    ...
    getDeclaredSubtypeWitness(Type* subType, Type* superType, DeclRef<Decl> const& declRef);

    TypePackSubtypeWitness*
    getSubtypeWitnessPack(Type* subType, Type* superType, ArrayView<SubtypeWitness*> witnesses);

    SubtypeWitness*
    getExpandSubtypeWitness(Type* subType, Type* superType, SubtypeWitness* patternWitness);

    SubtypeWitness*
    getEachSubtypeWitness(Type* subType, Type* superType, SubtypeWitness* patternWitness);
