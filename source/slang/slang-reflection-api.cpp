...
SLANG_API SlangTypeKind spReflectionType_GetKind(SlangReflectionType* inType)
{
    ...
    else if (as<VectorExpressionType>(type))
    {
        return SLANG_TYPE_KIND_VECTOR;
    }
    else if (as<MatrixExpressionType>(type))
    {
    ...
    else if (as<HLSLStreamOutputType>(type))
    {
    ...
    else if (as<TextureTypeBase>(type))
    {
        return SLANG_TYPE_KIND_RESOURCE;
    }
    else if (as<FeedbackType>(type))
    {
...
#undef CASE
    ...
    else if (as<ArrayExpressionType>(type))
    {
    ...
    else if (as<ExistentialSpecializedType>(type))
    {
...
SLANG_API unsigned int spReflectionType_GetRowCount(SlangReflectionType* inType)
{
    ...
    else if (as<BasicExpressionType>(type))
    {
        return 1;
    }
...
SlangBindingType _calcResourceBindingType(Type* type)
{
    ...
    else if (as<HLSLStructuredBufferTypeBase>(type))
    {
