...
/* Type */
    /* BasicType */
        INST(VoidType, Void, 0, HOISTABLE)
        INST(BoolType, Bool, 0, HOISTABLE)
        INST(Int8Type, Int8, 0, HOISTABLE)
        INST(Int16Type, Int16, 0, HOISTABLE)
        INST(IntType, Int, 0, HOISTABLE)
        INST(Int64Type, Int64, 0, HOISTABLE)
        INST(UInt8Type, UInt8, 0, HOISTABLE)
        INST(UInt16Type, UInt16, 0, HOISTABLE)
        INST(UIntType, UInt, 0, HOISTABLE)
        INST(UInt64Type, UInt64, 0, HOISTABLE)
        INST(HalfType, Half, 0, HOISTABLE)
        INST(FloatType, Float, 0, HOISTABLE)
        INST(DoubleType, Double, 0, HOISTABLE)
        INST(CharType, Char, 0, HOISTABLE)
        INST(IntPtrType, IntPtr, 0, HOISTABLE)
        INST(UIntPtrType, UIntPtr, 0, HOISTABLE)
    INST_RANGE(BasicType, VoidType, UIntPtrType)
    /* StringTypeBase */
    ...
    INST_RANGE(RawPointerTypeBase, RawPointerType, RTTIPointerType)
    /* ArrayTypeBase */
    ...
    INST_RANGE(Rate, ConstExprRate, ActualGlobalRate)
...
/* Decoration */
    ...
    INST_RANGE(CheckpointHintDecoration, PreferCheckpointDecoration, CheckpointIntermediateDecoration)
