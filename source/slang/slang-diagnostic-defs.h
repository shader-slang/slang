...
DIAGNOSTIC(41015, Error, usingUninitializedOut, "use of uninitialized out parameter '$0'")
DIAGNOSTIC(41016, Error, usingUninitializedVariable, "use of uninitialized variable '$0'")
