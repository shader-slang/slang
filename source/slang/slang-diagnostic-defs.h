...
DIAGNOSTIC(30093, Error, uncachedTryCallInNonThrowFunc, "the current function or environment is not declared to throw any errors, but the 'try' clause is not catched")
