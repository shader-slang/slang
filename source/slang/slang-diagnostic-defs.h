...
DIAGNOSTIC(
    ...
    "the capability for case '$0' is '$1', which is conflicts with previous case which requires '$2'."
    "In target_switch, if two cases are belong to the same target, then one capability set has to be "
