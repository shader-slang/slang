...
struct IRResourceTypeBase : IRType
{
    ...
    SlangResourceAccess getAccess()
    {
        ...
        if (constVal)
        {
            ...
            {
                case kStdlibResourceAccessReadOnly:  return SLANG_RESOURCE_ACCESS_READ;
                case kStdlibResourceAccessReadWrite: return SLANG_RESOURCE_ACCESS_READ_WRITE;
                case kStdlibResourceAccessRasterizerOrdered:
                    return SLANG_RESOURCE_ACCESS_RASTER_ORDERED;
                case kStdlibResourceAccessFeedback: return SLANG_RESOURCE_ACCESS_FEEDBACK;
                default:                            break;
            }
        }
...
String
getSlangIRAssembly(IRModule* module, const IRDumpOptions& options, SourceManager* sourceManager);
