...
SlangResult DocMarkupExtractor::extract(const SearchItemInput* inputs, Index inputCount, SourceManager* sourceManager, DiagnosticSink* sink, List<SourceView*>& outViews, List<SearchItemOutput>& out)
{
    ...
    entries.sort([](Entry& a, Entry& b) -> bool { return a.locOrOffset < b.locOrOffset; });

    {
        ...
        entries.sort([](Entry& a, Entry& b) -> bool { return (a.viewIndex < b.viewIndex) || ((a.viewIndex == b.viewIndex) && a.locOrOffset < b.locOrOffset); });
    }
