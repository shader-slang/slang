            ...
            if (returnType)
            {
                ...
                else
                {
                    ...
                    for (auto param : paramCloneInfos)
                    {
                        ...
                        // then we need to make a clone since it is likely to be dependent
                        // on the new parameters we just emitted and we want to obtain the
                        // effective type in the current context.
                        //
