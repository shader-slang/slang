...
IRFunc*
createMatrixPackFunc(IRMatrixType* matrixType, IRStructType* structType, IRArrayType* arrayType)
{
    IRBuilder builder(structType);
    builder.setInsertAfter(structType);
    auto func = builder.createFunc();
...
IRFunc*
createVectorPackFunc(IRVectorType* vectorType, IRStructType* structType, IRArrayType* arrayType)
{
    IRBuilder builder(structType);
    builder.setInsertAfter(structType);
    auto func = builder.createFunc();
...
LoweredBuiltinTypeInfo
lowerMatrixType(IRBuilder* builder, IRMatrixType* matrixType, String nameSuffix)
{
...
LoweredBuiltinTypeInfo
lowerVectorType(IRBuilder* builder, IRVectorType* vectorType, String nameSuffix)
{
    LoweredBuiltinTypeInfo info;
...
LoweredBuiltinTypeInfo
lowerType(BuiltinTypeLoweringEnv* env, IRBuilder* builder, IRType* type, String nameSuffix)
{
