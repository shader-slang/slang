...
public:
    ...
    DeclRefBase*
    _substituteImplOverride(ASTBuilder* astBuilder, SubstitutionSet subst, int* ioDiff);
...
class TypeCastIntVal : public IntVal
{
    ...
    static Val*
    tryFoldImpl(ASTBuilder* astBuilder, Type* resultType, Val* base, DiagnosticSink* sink);
