...
List<IRWitnessTable*>
SharedGenericsLoweringContext::getWitnessTablesFromInterfaceType(IRInst* interfaceType)
{
    return Slang::getWitnessTablesFromInterfaceType(module, interfaceType);
}

IRIntegerValue
SharedGenericsLoweringContext::getInterfaceAnyValueSize(IRInst* type, SourceLoc usageLoc)
{
