...
// The rule array is a compile-time constant, so the index is read-only after its constructor runs
// and safe to share across compiles. Build it lazily under the C++11 thread-safe function-local
// static guard.
