...
// resulting container. Reached only after the flat folded-name lookups miss, so builtin qualified
// attributes (`[vk::binding]`, registered under the flat name `vk_binding`) never take this path.
