...
local insts = {
	...
	{ DimsConcat = { operands = { { "leftPack" }, { "rightPack" }, { "axis" } }, hoistable = true } },
	{ DimsPermute = { operands = { { "pack" }, { "order" } }, hoistable = true } },
	{ DimsSwap = { operands = { { "pack" }, { "dim0" }, { "dim1" } }, hoistable = true } },
	{ DimsReduce = { operands = { { "pack" }, { "axis" } }, hoistable = true } },
