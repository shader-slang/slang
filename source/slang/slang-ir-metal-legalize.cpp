...
struct LegalizeMetalEntryPointContext
{
    ...
    MetalSystemValueInfo
    getSystemValueInfo(String inSemanticName, String* optionalSemanticIndex, IRInst* parentVar)
    {
    ...
    IRLayoutDecoration*
    _simplifyUserSemanticNames(IRBuilder& builder, IRLayoutDecoration* layoutDecor)
    {
            ...
            if (returnStructType != flattenedStruct)
            {
                ...
                _replaceAllReturnInst(
                    ...
                    [&](IRBuilder& copyBuilder, IRStructType* dstType, IRInst* srcVal) -> IRInst*
                    {
                        ...
                        mapOldFieldToNewField.emitCopy<(int
                        )MapStructToFlatStruct::CopyOptions::StructIntoFlatStruct>(
                            copyBuilder,
                            dstVal,
                            srcVal
                        );
                ...
                if (!entryPointToGroupThreadId.containsKey(entryPoint.entryPointFunc))
                {
                    ...
                    if (!entryPointToGroupThreadId.containsKey(entryPoint.entryPointFunc))
                    {
                        ...
                        SystemValLegalizationWorkItem newWorkItem =
                            {groupThreadId, groupThreadIDString, semanticIndex};
