...
struct BindExistentialSlots
{
    ...
    //
    void
    processEntryPointParameter(IRInst* param, IRInst* bindSlotsInst, Index& ioSlotOperandOffset)
    {
    ...
    void
    replaceTypeUsingExistentialSlots(IRInst* inst, UInt slotOperandCount, IRUse const* slotArgs)
    {
