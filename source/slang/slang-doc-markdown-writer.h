...
struct DeclDocumentation
{
    ...
    void
    writeSection(StringBuilder& sb, DocMarkdownWriter* writer, Decl* decl, DocPageSection section);
};
...
struct DocMarkdownWriter
{
    ...
    void
    writeAggType(DocumentPage* page, const ASTMarkup::Entry& entry, AggTypeDeclBase* aggTypeDecl);
