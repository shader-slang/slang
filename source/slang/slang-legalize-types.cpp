...
static IRType*
createBuiltinGenericType(TypeLegalizationContext* context, IROp op, IRType* elementType)
{
...
// element type.
static LegalType
createLegalUniformBufferType(TypeLegalizationContext* context, IROp op, LegalType legalElementType)
{
...
//
LegalElementWrapping
declareStructFields(TypeLegalizationContext* context, IRStructType* structType, LegalType fieldType)
{
...
IRVarLayout*
createSimpleVarLayout(IRBuilder* irBuilder, SimpleLegalVarChain* varChain, IRTypeLayout* typeLayout)
{
    if (!typeLayout)
        return nullptr;
