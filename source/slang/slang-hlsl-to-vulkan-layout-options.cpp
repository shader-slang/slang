...
HLSLToVulkanLayoutOptions::Binding
HLSLToVulkanLayoutOptions::inferBinding(Kind kind, const Binding& inBinding) const
{
...
/* static */ HLSLToVulkanLayoutOptions::Kind
HLSLToVulkanLayoutOptions::getKind(slang::ParameterCategory param)
{
