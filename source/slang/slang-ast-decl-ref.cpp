...
DeclRefBase*
DirectDeclRef::_substituteImplOverride(ASTBuilder* astBuilder, SubstitutionSet subst, int* ioDiff)
{
...
DeclRefBase*
MemberDeclRef::_substituteImplOverride(ASTBuilder* astBuilder, SubstitutionSet subst, int* ioDiff)
{
    int diff = 0;
...
DeclRefBase*
LookupDeclRef::_substituteImplOverride(ASTBuilder* astBuilder, SubstitutionSet subst, int* ioDiff)
{
    int diff = 0;
...
)
{
    ...
    (*ioDiff)++;
    return astBuilder
        ->getGenericAppDeclRef(substGenericDeclRef, substArgs.getArrayView(), getDecl());
}
...
DeclRefBase*
SubstitutionSet::applyToDeclRef(ASTBuilder* astBuilder, DeclRefBase* otherDeclRef) const
{
    int diff = 0;
