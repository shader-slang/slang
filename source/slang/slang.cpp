    ...
    slang::IBlob**  outDiagnostics)
{
    ...
    DiagnosticSink sink(getSourceManager(), Lexer::diagnosticLexer);
...
EndToEndCompileRequest::EndToEndCompileRequest(
    Session* session)
    : m_session(session)
    , m_sink(nullptr, Lexer::diagnosticLexer)
{
...
SLANG_NO_THROW SlangResult SLANG_MCALL ComponentType::specialize(
    ...
    ISlangBlob**                    outDiagnostics)
{
    DiagnosticSink sink(getLinkage()->getSourceManager(), Lexer::diagnosticLexer);
