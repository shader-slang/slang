...
{
    out.append("TypeEqualityWitness(");
    sub->toText(out);
    out.append(")");
}
...
{
    out.append("DeclaredSubtypeWitness(");
    sub->toText(out);
    out.append(", ");
    sup->toText(out);
    out.append(", ");
...
void TransitiveSubtypeWitness::_toTextOverride(StringBuilder& out)
{
    ...
    out.append("TransitiveSubtypeWitness(");
    subToMid->toText(out);
    out.append(", ");
    midToSup->toText(out);
    out.append(")");
...
{
    out.append("extractExistentialValue(");
    declRef.toText(out);
    out.append(")");
}
...
{
    out.append("TaggedUnionSubtypeWitness(");
    bool first = true;
