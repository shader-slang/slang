...
public:
    ...
    FunctionDifferentiableLevel
    _getFuncDifferentiableLevelImpl(FunctionDeclBase* func, int recurseLimit);
    ...
    InheritanceInfo
    getInheritanceInfo(Type* type, InheritanceCircularityInfo* circularityInfo = nullptr);
...
public:
    ...
    DeclRef<Decl>
    getSpecializedDeclRef(Decl* declToSpecialize, DeclRef<Decl> declRefWithSpecializationArgs)
    {
    ...
    void
    diagnoseAmbiguousReference(OverloadedExpr* overloadedExpr, LookupResult const& lookupResult);
    ...
    bool
    CoerceToProperTypeImpl(TypeExp const& typeExp, Type** outProperType, DiagnosticSink* diagSink);
...
public:
    ...
    AttributeBase*
    checkAttribute(UncheckedAttribute* uncheckedAttr, ModifiableSyntaxNode* attrTarget);

    Modifier*
    checkModifier(Modifier* m, ModifiableSyntaxNode* syntaxNode, bool ignoreUnallowedModifier);
    ...
    bool
    TryCheckOverloadCandidateTypes(OverloadResolveContext& context, OverloadCandidate& candidate);
    ...
    Expr*
    CheckSwizzleExpr(MemberExpr* memberRefExpr, Type* baseElementType, IntVal* baseElementCount);
