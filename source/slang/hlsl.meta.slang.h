...
SLANG_RAW("    let specular = step(0.0f, n_dot_l) * max(n_dot_h * m, 0.0f);\n")
...
// that choice.
SLANG_RAW("#line 1766 \"hlsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("// vector-matrix\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int, let M : int>\n")
SLANG_RAW("__intrinsic_op(mulVectorMatrix)\n")
SLANG_RAW("vector<T,M> mul(vector<T,N> x, matrix<T,N,M> y);\n")
SLANG_RAW("\n")
SLANG_RAW("// matrix-vector\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int, let M : int>\n")
SLANG_RAW("__intrinsic_op(mulMatrixVector)\n")
SLANG_RAW("vector<T,N> mul(matrix<T,N,M> x, vector<T,M> y);\n")
SLANG_RAW("\n")
SLANG_RAW("// matrix-matrix\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let R : int, let N : int, let C : int>\n")
SLANG_RAW("__intrinsic_op(mulMatrixMatrix)\n")
SLANG_RAW("matrix<T,R,C> mul(matrix<T,R,N> x, matrix<T,N,C> y);\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 2652 \"hlsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
