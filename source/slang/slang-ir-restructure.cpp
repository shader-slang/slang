        ...
        case kIROp_Loop:
            {
                ...
                // is because we will always emit a headerless unconditional loop
                // with no continue clause at all, so that a `continue` in the
                // output code will always refer to the top of the loop.
                //
