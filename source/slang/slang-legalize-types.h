...
struct LegalType
{
    ...
    static LegalType
    pair(LegalType const& ordinaryType, LegalType const& specialType, RefPtr<PairInfo> pairInfo);
...
IRVarLayout*
createVarLayout(IRBuilder* irBuilder, LegalVarChain const& varChain, IRTypeLayout* typeLayout);
...
struct LegalVal
{
    ...
    static LegalVal
    pair(LegalVal const& ordinaryVal, LegalVal const& specialVal, RefPtr<PairInfo> pairInfo);
