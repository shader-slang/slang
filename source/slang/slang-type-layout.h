...
struct SimpleLayoutRulesImpl
{
    ...
    virtual SimpleArrayLayoutInfo
    GetArrayLayout(SimpleLayoutInfo elementInfo, LayoutSize elementCount) = 0;
    ...
    GetVectorLayout(BaseType elementType, SimpleLayoutInfo elementInfo, size_t elementCount) = 0;
    ...
    virtual LayoutSize
    AddStructField(UniformLayoutInfo* ioStructInfo, UniformLayoutInfo fieldInfo) = 0;
...
struct LayoutRulesImpl
{
    ...
    SimpleLayoutInfo
    GetVectorLayout(BaseType elementType, SimpleLayoutInfo elementInfo, size_t elementCount)
    {
    ...
    ObjectLayoutInfo
    GetObjectLayout(ShaderParameterKind kind, const ObjectLayoutRulesImpl::Options& options)
    {
...
struct TypeLayoutContext
{
    ...
    TypeLayoutContext
    withSpecializationArgs(ExpandedSpecializationArg const* args, Int argCount) const
    {
        TypeLayoutContext result = *this;
...
public:
    ...
    RefPtr<VarLayout>
    addExplicitUniformField(DeclRef<VarDeclBase> field, TypeLayoutResult fieldResult);
