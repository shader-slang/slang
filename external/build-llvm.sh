...
cmake_arguments_for_slang=(
  ...
  -DLLVM_TOOL_LTO_BUILD=0
  -DLLVM_TOOL_GOLD_BUILD=0
  -DLLVM_TOOL_LLVM_AR_BUILD=0
  -DLLVM_TOOL_LLVM_CFI_VERIFY_BUILD=0
  -DLLVM_TOOL_LLVM_CONFIG_BUILD=0
  -DLLVM_TOOL_LLVM_CTXPROF_UTIL_BUILD=0
  -DLLVM_TOOL_LLVM_DIFF_BUILD=0
  -DLLVM_TOOL_LLVM_LTO_BUILD=0
  -DLLVM_TOOL_LLVM_PROFDATA_BUILD=0
  -DLLVM_TOOL_LLVM_ISEL_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_MICROSOFT_DEMANGLE_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_OPT_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_DLANG_DEMANGLE_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_RUST_DEMANGLE_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_ITANIUM_DEMANGLE_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_SPECIAL_CASE_LIST_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_YAML_NUMERIC_PARSER_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_YAML_PARSER_FUZZER_BUILD=0
  -DLLVM_TOOL_LLVM_REMARKS_SHLIB_BUILD=0
  -DLLVM_TOOL_LLVM_EXEGESIS_BUILD=0
  -DLLVM_TOOL_OPT_BUILD=0
  -DLLVM_TOOL_OPT_VIEWER_BUILD=0
  -DLLVM_ENABLE_DIA_SDK=0
  -DCLANG_BUILD_TOOLS=0
  -DCLANG_TOOL_DIAGTOOL_BUILD=0
  -DCLANG_TOOL_APINOTES_TEST_BUILD=0
  -DCLANG_TOOL_CLANG_IMPORT_TEST_BUILD=0
  -DCLANG_TOOL_C_INDEX_TEST_BUILD=0
  -DCLANG_TOOL_CLANG_DIFF_BUILD=0
  -DCLANG_TOOL_CLANG_FUZZER_BUILD=0
  -DCLANG_TOOL_LIBCLANG_BUILD=0
  -DCLANG_ENABLE_STATIC_ANALYZER=0
  -DCLANG_ENABLE_OBJC_REWRITER=0
