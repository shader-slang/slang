...
```bash
cmake --build --preset release --target slangc >/dev/null 2>&1 || cmake --build --preset release --target slangc
...
./build/Release/bin/slangc -dump-ir -target <target> -o /dev/null test.slang 2>&1 | \
