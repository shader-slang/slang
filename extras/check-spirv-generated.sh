...
if [ "$DIFF_FOUND" = true ]; then
  ...
  echo "  cmake . -B build-generated"
  echo "  python3 utils/update_build_version.py CHANGES build-generated/build-version.inc"
  echo "  cmake --build build-generated --target core_tables --target extinst_tables"
  echo "  cd ../.."
  echo "  rm external/spirv-tools-generated/*.h external/spirv-tools-generated/*.inc"
  echo "  cp external/spirv-tools/build-generated/*.h external/spirv-tools-generated/"
  echo "  cp external/spirv-tools/build-generated/*.inc external/spirv-tools-generated/"
  echo "  git add external/spirv-tools-generated"
  echo ""
  echo "Note: do not use 'build' as the CMake build directory. git-sync-deps checks"
  echo "out Chromium's //build tree into external/spirv-tools/build/, and the copy"
  echo "step would then pick up its headers (build_config.h, buildflag.h,"
  echo "precompile.h) as orphaned files."
  echo ""
