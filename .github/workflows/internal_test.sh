...
# Usage: ./trigger_pipeline.sh <GitLab Pipeline API Endpoint> <Access Token>
# Example: ./trigger_pipeline.sh "https://gitlab.com/api/v4/projects/<project_id>/pipeline" "<access_token>"
